...
flutter {
    ...
    target = requestedAppTarget?.let { target ->
        jsonString(target, "packageEntrypoint", jsonString(target, "id", "target"))
    } ?: "lib/main.dart"
}
