...
@JsonKey(includeToJson: false) String get uid; String get name; String get firstName; String get lastName;@TimestampConverter() DateTime get dateOfBirth; Gender get gender; String get phoneNumber; bool get profileComplete;// Optional profile/contact field. Authentication is phone-only.
 String get email; String get bio; String? get instagramHandle;// Photos
 List<String> get photoUrls;// Location
@JsonKey(unknownEnumValue: null) IndianCity? get city; double? get latitude; double? get longitude;// Matching preferences
...
as double?,joinedRunClubIds: null == joinedRunClubIds ? _self.joinedRunClubIds : joinedRunClubIds // ignore: cast_nullable_to_non_nullable
...
class _UserProfile extends UserProfile {
  const _UserProfile({@JsonKey(includeToJson: false) required this.uid, required this.name, this.firstName = '', this.lastName = '', @TimestampConverter() required this.dateOfBirth, required this.gender, required this.phoneNumber, required this.profileComplete, this.email = '', this.bio = '', this.instagramHandle, final  List<String> photoUrls = const [], @JsonKey(unknownEnumValue: null) this.city, this.latitude, this.longitude, final  List<String> joinedRunClubIds = const [], final  List<String> savedRunIds = const [], final  List<Gender> interestedInGenders = const [], this.minAgePreference = 18, this.maxAgePreference = maximumPreferredMatchAge, this.height, this.occupation, this.company, @JsonKey(unknownEnumValue: null) this.education, @JsonKey(unknownEnumValue: null) this.religion, final  List<Language> languages = const [], @JsonKey(unknownEnumValue: null) this.relationshipGoal, @JsonKey(unknownEnumValue: null) this.drinking, @JsonKey(unknownEnumValue: null) this.smoking, @JsonKey(unknownEnumValue: null) this.workout, @JsonKey(unknownEnumValue: null) this.diet, @JsonKey(unknownEnumValue: null) this.children, this.paceMinSecsPerKm = 300, this.paceMaxSecsPerKm = 420, final  List<PreferredDistance> preferredDistances = const [], final  List<RunReason> runningReasons = const [], this.prefsNewCatches = true, this.prefsRunReminders = true, this.prefsWeeklyDigest = false, this.prefsShowOnMap = true}): _photoUrls = photoUrls,_joinedRunClubIds = joinedRunClubIds,_savedRunIds = savedRunIds,_interestedInGenders = interestedInGenders,_languages = languages,_preferredDistances = preferredDistances,_runningReasons = runningReasons,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UserProfile&&(identical(other.uid, uid) || other.uid == uid)&&(identical(other.name, name) || other.name == name)&&(identical(other.firstName, firstName) || other.firstName == firstName)&&(identical(other.lastName, lastName) || other.lastName == lastName)&&(identical(other.dateOfBirth, dateOfBirth) || other.dateOfBirth == dateOfBirth)&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.phoneNumber, phoneNumber) || other.phoneNumber == phoneNumber)&&(identical(other.profileComplete, profileComplete) || other.profileComplete == profileComplete)&&(identical(other.email, email) || other.email == email)&&(identical(other.bio, bio) || other.bio == bio)&&(identical(other.instagramHandle, instagramHandle) || other.instagramHandle == instagramHandle)&&const DeepCollectionEquality().equals(other._photoUrls, _photoUrls)&&(identical(other.city, city) || other.city == city)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude)&&const DeepCollectionEquality().equals(other._joinedRunClubIds, _joinedRunClubIds)&&const DeepCollectionEquality().equals(other._savedRunIds, _savedRunIds)&&const DeepCollectionEquality().equals(other._interestedInGenders, _interestedInGenders)&&(identical(other.minAgePreference, minAgePreference) || other.minAgePreference == minAgePreference)&&(identical(other.maxAgePreference, maxAgePreference) || other.maxAgePreference == maxAgePreference)&&(identical(other.height, height) || other.height == height)&&(identical(other.occupation, occupation) || other.occupation == occupation)&&(identical(other.company, company) || other.company == company)&&(identical(other.education, education) || other.education == education)&&(identical(other.religion, religion) || other.religion == religion)&&const DeepCollectionEquality().equals(other._languages, _languages)&&(identical(other.relationshipGoal, relationshipGoal) || other.relationshipGoal == relationshipGoal)&&(identical(other.drinking, drinking) || other.drinking == drinking)&&(identical(other.smoking, smoking) || other.smoking == smoking)&&(identical(other.workout, workout) || other.workout == workout)&&(identical(other.diet, diet) || other.diet == diet)&&(identical(other.children, children) || other.children == children)&&(identical(other.paceMinSecsPerKm, paceMinSecsPerKm) || other.paceMinSecsPerKm == paceMinSecsPerKm)&&(identical(other.paceMaxSecsPerKm, paceMaxSecsPerKm) || other.paceMaxSecsPerKm == paceMaxSecsPerKm)&&const DeepCollectionEquality().equals(other._preferredDistances, _preferredDistances)&&const DeepCollectionEquality().equals(other._runningReasons, _runningReasons)&&(identical(other.prefsNewCatches, prefsNewCatches) || other.prefsNewCatches == prefsNewCatches)&&(identical(other.prefsRunReminders, prefsRunReminders) || other.prefsRunReminders == prefsRunReminders)&&(identical(other.prefsWeeklyDigest, prefsWeeklyDigest) || other.prefsWeeklyDigest == prefsWeeklyDigest)&&(identical(other.prefsShowOnMap, prefsShowOnMap) || other.prefsShowOnMap == prefsShowOnMap));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,uid,name,firstName,lastName,dateOfBirth,gender,phoneNumber,profileComplete,email,bio,instagramHandle,const DeepCollectionEquality().hash(_photoUrls),city,latitude,longitude,const DeepCollectionEquality().hash(_joinedRunClubIds),const DeepCollectionEquality().hash(_savedRunIds),const DeepCollectionEquality().hash(_interestedInGenders),minAgePreference,maxAgePreference,height,occupation,company,education,religion,const DeepCollectionEquality().hash(_languages),relationshipGoal,drinking,smoking,workout,diet,children,paceMinSecsPerKm,paceMaxSecsPerKm,const DeepCollectionEquality().hash(_preferredDistances),const DeepCollectionEquality().hash(_runningReasons),prefsNewCatches,prefsRunReminders,prefsWeeklyDigest,prefsShowOnMap]);
...
/// Create a copy of UserProfile
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uid = null,Object? name = null,Object? firstName = null,Object? lastName = null,Object? dateOfBirth = null,Object? gender = null,Object? phoneNumber = null,Object? profileComplete = null,Object? email = null,Object? bio = null,Object? instagramHandle = freezed,Object? photoUrls = null,Object? city = freezed,Object? latitude = freezed,Object? longitude = freezed,Object? joinedRunClubIds = null,Object? savedRunIds = null,Object? interestedInGenders = null,Object? minAgePreference = null,Object? maxAgePreference = null,Object? height = freezed,Object? occupation = freezed,Object? company = freezed,Object? education = freezed,Object? religion = freezed,Object? languages = null,Object? relationshipGoal = freezed,Object? drinking = freezed,Object? smoking = freezed,Object? workout = freezed,Object? diet = freezed,Object? children = freezed,Object? paceMinSecsPerKm = null,Object? paceMaxSecsPerKm = null,Object? preferredDistances = null,Object? runningReasons = null,Object? prefsNewCatches = null,Object? prefsRunReminders = null,Object? prefsWeeklyDigest = null,Object? prefsShowOnMap = null,}) {
...
as IndianCity?,latitude: freezed == latitude ? _self.latitude : latitude // ignore: cast_nullable_to_non_nullable
as double?,longitude: freezed == longitude ? _self.longitude : longitude // ignore: cast_nullable_to_non_nullable
as double?,joinedRunClubIds: null == joinedRunClubIds ? _self._joinedRunClubIds : joinedRunClubIds // ignore: cast_nullable_to_non_nullable
