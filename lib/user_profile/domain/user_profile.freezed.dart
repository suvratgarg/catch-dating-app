...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,uid,name,firstName,lastName,displayName,dateOfBirth,gender,phoneNumber,profileComplete,email,instagramHandle,const DeepCollectionEquality().hash(_profilePrompts),const DeepCollectionEquality().hash(_photoUrls),const DeepCollectionEquality().hash(_photoThumbnailUrls),const DeepCollectionEquality().hash(_photoPrompts),const DeepCollectionEquality().hash(_profilePhotos),city,latitude,longitude,const DeepCollectionEquality().hash(_interestedInGenders),minAgePreference,maxAgePreference,height,occupation,company,education,religion,const DeepCollectionEquality().hash(_languages),relationshipGoal,drinking,smoking,workout,diet,children,paceMinSecsPerKm,paceMaxSecsPerKm,const DeepCollectionEquality().hash(_preferredDistances),const DeepCollectionEquality().hash(_runningReasons),const DeepCollectionEquality().hash(_preferredRunTimes),prefsNewCatches,prefsMessages,prefsRunReminders,prefsRunStatusUpdates,prefsClubUpdates,prefsWeeklyDigest,prefsShowOnMap]);
