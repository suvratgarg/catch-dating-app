...
@JsonKey(includeToJson: false) String get uid; String get name;@TimestampConverter() DateTime get dateOfBirth; Gender get gender; String get phoneNumber; bool get profileComplete;// Optional profile/contact field. Authentication is phone-only.
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,uid,name,dateOfBirth,gender,phoneNumber,profileComplete,email,bio,instagramHandle,const DeepCollectionEquality().hash(_photoUrls),city,latitude,longitude,const DeepCollectionEquality().hash(_joinedRunClubIds),const DeepCollectionEquality().hash(_savedRunIds),const DeepCollectionEquality().hash(_interestedInGenders),minAgePreference,maxAgePreference,height,occupation,company,education,religion,const DeepCollectionEquality().hash(_languages),relationshipGoal,drinking,smoking,workout,diet,children,paceMinSecsPerKm,paceMaxSecsPerKm,const DeepCollectionEquality().hash(_preferredDistances),const DeepCollectionEquality().hash(_runningReasons),prefsNewCatches,prefsRunReminders,prefsWeeklyDigest,prefsShowOnMap]);
