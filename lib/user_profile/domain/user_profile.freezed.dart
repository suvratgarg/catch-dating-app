...
@JsonKey(includeToJson: false) String get uid; String get name; String get firstName; String get lastName; String get displayName;@TimestampConverter() DateTime get dateOfBirth; Gender get gender; String get phoneNumber; bool get profileComplete;// Optional profile/contact field. Authentication is phone-only.
 String get email; String? get instagramHandle;// Personality prompts
 List<ProfilePromptAnswer> get profilePrompts;// Photos
 List<String> get photoUrls; List<String> get photoThumbnailUrls; List<PhotoPromptAnswer> get photoPrompts;// Location
...
@JsonKey(unknownEnumValue: null) DrinkingHabit? get drinking;@JsonKey(unknownEnumValue: null) SmokingHabit? get smoking;@JsonKey(unknownEnumValue: null) WorkoutFrequency? get workout;@JsonKey(unknownEnumValue: null) DietaryPreference? get diet;@JsonKey(unknownEnumValue: null) ChildrenStatus? get children;// Running preferences (set during onboarding)
 int get paceMinSecsPerKm; int get paceMaxSecsPerKm; List<PreferredDistance> get preferredDistances; List<RunReason> get runningReasons; List<PreferredRunTime> get preferredRunTimes;// Notification / discovery preferences
 bool get prefsNewCatches; bool get prefsMessages; bool get prefsRunReminders; bool get prefsRunStatusUpdates; bool get prefsClubUpdates; bool get prefsWeeklyDigest; bool get prefsShowOnMap;
...
@useResult
$Res call({
@JsonKey(includeToJson: false) String uid, String name, String firstName, String lastName, String displayName,@TimestampConverter() DateTime dateOfBirth, Gender gender, String phoneNumber, bool profileComplete, String email, String? instagramHandle, List<ProfilePromptAnswer> profilePrompts, List<String> photoUrls, List<String> photoThumbnailUrls, List<PhotoPromptAnswer> photoPrompts, String? city, double? latitude, double? longitude, List<Gender> interestedInGenders, int minAgePreference, int maxAgePreference, int? height, String? occupation, String? company,@JsonKey(unknownEnumValue: null) EducationLevel? education,@JsonKey(unknownEnumValue: null) Religion? religion, List<Language> languages,@JsonKey(unknownEnumValue: null) RelationshipGoal? relationshipGoal,@JsonKey(unknownEnumValue: null) DrinkingHabit? drinking,@JsonKey(unknownEnumValue: null) SmokingHabit? smoking,@JsonKey(unknownEnumValue: null) WorkoutFrequency? workout,@JsonKey(unknownEnumValue: null) DietaryPreference? diet,@JsonKey(unknownEnumValue: null) ChildrenStatus? children, int paceMinSecsPerKm, int paceMaxSecsPerKm, List<PreferredDistance> preferredDistances, List<RunReason> runningReasons, List<PreferredRunTime> preferredRunTimes, bool prefsNewCatches, bool prefsMessages, bool prefsRunReminders, bool prefsRunStatusUpdates, bool prefsClubUpdates, bool prefsWeeklyDigest, bool prefsShowOnMap
});
...
as List<PreferredRunTime>,prefsNewCatches: null == prefsNewCatches ? _self.prefsNewCatches : prefsNewCatches // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _UserProfile() when $default != null:
return $default(_that.uid,_that.name,_that.firstName,_that.lastName,_that.displayName,_that.dateOfBirth,_that.gender,_that.phoneNumber,_that.profileComplete,_that.email,_that.instagramHandle,_that.profilePrompts,_that.photoUrls,_that.photoThumbnailUrls,_that.photoPrompts,_that.city,_that.latitude,_that.longitude,_that.interestedInGenders,_that.minAgePreference,_that.maxAgePreference,_that.height,_that.occupation,_that.company,_that.education,_that.religion,_that.languages,_that.relationshipGoal,_that.drinking,_that.smoking,_that.workout,_that.diet,_that.children,_that.paceMinSecsPerKm,_that.paceMaxSecsPerKm,_that.preferredDistances,_that.runningReasons,_that.preferredRunTimes,_that.prefsNewCatches,_that.prefsMessages,_that.prefsRunReminders,_that.prefsRunStatusUpdates,_that.prefsClubUpdates,_that.prefsWeeklyDigest,_that.prefsShowOnMap);case _:
  return orElse();
...
class _UserProfile extends UserProfile {
  const _UserProfile({@JsonKey(includeToJson: false) required this.uid, required this.name, this.firstName = '', this.lastName = '', this.displayName = '', @TimestampConverter() required this.dateOfBirth, required this.gender, required this.phoneNumber, required this.profileComplete, this.email = '', this.instagramHandle, final  List<ProfilePromptAnswer> profilePrompts = const [], final  List<String> photoUrls = const [], final  List<String> photoThumbnailUrls = const [], final  List<PhotoPromptAnswer> photoPrompts = const [], this.city, this.latitude, this.longitude, final  List<Gender> interestedInGenders = const [], this.minAgePreference = 18, this.maxAgePreference = maximumPreferredMatchAge, this.height, this.occupation, this.company, @JsonKey(unknownEnumValue: null) this.education, @JsonKey(unknownEnumValue: null) this.religion, final  List<Language> languages = const [], @JsonKey(unknownEnumValue: null) this.relationshipGoal, @JsonKey(unknownEnumValue: null) this.drinking, @JsonKey(unknownEnumValue: null) this.smoking, @JsonKey(unknownEnumValue: null) this.workout, @JsonKey(unknownEnumValue: null) this.diet, @JsonKey(unknownEnumValue: null) this.children, this.paceMinSecsPerKm = 300, this.paceMaxSecsPerKm = 420, final  List<PreferredDistance> preferredDistances = const [], final  List<RunReason> runningReasons = const [], final  List<PreferredRunTime> preferredRunTimes = const [], this.prefsNewCatches = true, this.prefsMessages = true, this.prefsRunReminders = true, this.prefsRunStatusUpdates = true, this.prefsClubUpdates = true, this.prefsWeeklyDigest = false, this.prefsShowOnMap = true}): _profilePrompts = profilePrompts,_photoUrls = photoUrls,_photoThumbnailUrls = photoThumbnailUrls,_photoPrompts = photoPrompts,_interestedInGenders = interestedInGenders,_languages = languages,_preferredDistances = preferredDistances,_runningReasons = runningReasons,_preferredRunTimes = preferredRunTimes,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UserProfile&&(identical(other.uid, uid) || other.uid == uid)&&(identical(other.name, name) || other.name == name)&&(identical(other.firstName, firstName) || other.firstName == firstName)&&(identical(other.lastName, lastName) || other.lastName == lastName)&&(identical(other.displayName, displayName) || other.displayName == displayName)&&(identical(other.dateOfBirth, dateOfBirth) || other.dateOfBirth == dateOfBirth)&&(identical(other.gender, gender) || other.gender == gender)&&(identical(other.phoneNumber, phoneNumber) || other.phoneNumber == phoneNumber)&&(identical(other.profileComplete, profileComplete) || other.profileComplete == profileComplete)&&(identical(other.email, email) || other.email == email)&&(identical(other.instagramHandle, instagramHandle) || other.instagramHandle == instagramHandle)&&const DeepCollectionEquality().equals(other._profilePrompts, _profilePrompts)&&const DeepCollectionEquality().equals(other._photoUrls, _photoUrls)&&const DeepCollectionEquality().equals(other._photoThumbnailUrls, _photoThumbnailUrls)&&const DeepCollectionEquality().equals(other._photoPrompts, _photoPrompts)&&(identical(other.city, city) || other.city == city)&&(identical(other.latitude, latitude) || other.latitude == latitude)&&(identical(other.longitude, longitude) || other.longitude == longitude)&&const DeepCollectionEquality().equals(other._interestedInGenders, _interestedInGenders)&&(identical(other.minAgePreference, minAgePreference) || other.minAgePreference == minAgePreference)&&(identical(other.maxAgePreference, maxAgePreference) || other.maxAgePreference == maxAgePreference)&&(identical(other.height, height) || other.height == height)&&(identical(other.occupation, occupation) || other.occupation == occupation)&&(identical(other.company, company) || other.company == company)&&(identical(other.education, education) || other.education == education)&&(identical(other.religion, religion) || other.religion == religion)&&const DeepCollectionEquality().equals(other._languages, _languages)&&(identical(other.relationshipGoal, relationshipGoal) || other.relationshipGoal == relationshipGoal)&&(identical(other.drinking, drinking) || other.drinking == drinking)&&(identical(other.smoking, smoking) || other.smoking == smoking)&&(identical(other.workout, workout) || other.workout == workout)&&(identical(other.diet, diet) || other.diet == diet)&&(identical(other.children, children) || other.children == children)&&(identical(other.paceMinSecsPerKm, paceMinSecsPerKm) || other.paceMinSecsPerKm == paceMinSecsPerKm)&&(identical(other.paceMaxSecsPerKm, paceMaxSecsPerKm) || other.paceMaxSecsPerKm == paceMaxSecsPerKm)&&const DeepCollectionEquality().equals(other._preferredDistances, _preferredDistances)&&const DeepCollectionEquality().equals(other._runningReasons, _runningReasons)&&const DeepCollectionEquality().equals(other._preferredRunTimes, _preferredRunTimes)&&(identical(other.prefsNewCatches, prefsNewCatches) || other.prefsNewCatches == prefsNewCatches)&&(identical(other.prefsMessages, prefsMessages) || other.prefsMessages == prefsMessages)&&(identical(other.prefsRunReminders, prefsRunReminders) || other.prefsRunReminders == prefsRunReminders)&&(identical(other.prefsRunStatusUpdates, prefsRunStatusUpdates) || other.prefsRunStatusUpdates == prefsRunStatusUpdates)&&(identical(other.prefsClubUpdates, prefsClubUpdates) || other.prefsClubUpdates == prefsClubUpdates)&&(identical(other.prefsWeeklyDigest, prefsWeeklyDigest) || other.prefsWeeklyDigest == prefsWeeklyDigest)&&(identical(other.prefsShowOnMap, prefsShowOnMap) || other.prefsShowOnMap == prefsShowOnMap));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,uid,name,firstName,lastName,displayName,dateOfBirth,gender,phoneNumber,profileComplete,email,instagramHandle,const DeepCollectionEquality().hash(_profilePrompts),const DeepCollectionEquality().hash(_photoUrls),const DeepCollectionEquality().hash(_photoThumbnailUrls),const DeepCollectionEquality().hash(_photoPrompts),city,latitude,longitude,const DeepCollectionEquality().hash(_interestedInGenders),minAgePreference,maxAgePreference,height,occupation,company,education,religion,const DeepCollectionEquality().hash(_languages),relationshipGoal,drinking,smoking,workout,diet,children,paceMinSecsPerKm,paceMaxSecsPerKm,const DeepCollectionEquality().hash(_preferredDistances),const DeepCollectionEquality().hash(_runningReasons),const DeepCollectionEquality().hash(_preferredRunTimes),prefsNewCatches,prefsMessages,prefsRunReminders,prefsRunStatusUpdates,prefsClubUpdates,prefsWeeklyDigest,prefsShowOnMap]);
