...
abstract final class SwipeKeys {
  static const passButton = ValueKey('swipes.deck.pass');
  static const likeButton = ValueKey('swipes.deck.like');
  ...
  static const paceRangeSlider = ValueKey('swipes.filters.pace_range');
  ...
  static ValueKey<String> distanceFilterChip(String distanceName) =>
      ValueKey('swipes.filters.distance.$distanceName');
