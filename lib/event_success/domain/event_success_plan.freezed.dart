...
switch (_that) {
case _EventSuccessPlan() when $default != null:
return $default(_that.id,_that.eventId,_that.clubId,_that.layoutId,_that.playbookId,_that.selectedModuleIds,_that.targetAttendeeCount,_that.structureConfig,_that.hostGoal,_that.wingmanRequestsEnabled,_that.contextualOpenersEnabled,_that.compatibilityAffectsRanking,_that.questionnaireConfig,_that.activeStepIndex,_that.liveControlRevision,_that.assignmentDraftRevision,_that.publishedRotationRoundIndex,_that.publishedRevealRoundIndex,_that.status,_that.revealStatus,_that.activeRevealRoundIndex,_that.revealStartedAt,_that.attendeePrompt,_that.createdAt,_that.updatedAt,_that.frozenAt,_that.completedAt);case _:
  return orElse();
