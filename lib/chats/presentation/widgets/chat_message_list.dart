...
class _ChatMessageListSkeleton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: const [
        _ChatDateSkeleton(),
        _ChatBubbleSkeleton(isMe: false, widthFactor: 0.62),
        _ChatBubbleSkeleton(isMe: false, widthFactor: 0.48),
        _ChatBubbleSkeleton(isMe: true, widthFactor: 0.58),
        _ChatBubbleSkeleton(isMe: true, widthFactor: 0.42),
        _ChatBubbleSkeleton(isMe: false, widthFactor: 0.68),
      ],
    );
  }
}
