...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,location,area,hostUserId,hostName,hostAvatarUrl,ownerUserId,const DeepCollectionEquality().hash(_hostUserIds),const DeepCollectionEquality().hash(_hostProfiles),createdAt,imageUrl,profileImageUrl,const DeepCollectionEquality().hash(_clubPhotos),logoPhoto,const DeepCollectionEquality().hash(_tags),memberCount,rating,reviewCount,nextEventAt,nextEventLabel,instagramHandle,phoneNumber,email,status,archived,archivedAt,archiveReason,appVisibility,hostDefaults]);
