...
as ClubAppVisibility,hostDefaults: null == hostDefaults ? _self.hostDefaults : hostDefaults // ignore: cast_nullable_to_non_nullable
as ClubHostDefaults,
  ));
}
/// Create a copy of Club
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeToJson: false)  String id,  String name,  String description,  String location,  String locationCityId,  String locationMarketId,  String area,  String? hostUserId,  String? hostName,  String? hostAvatarUrl,  String? ownerUserId,  List<String> hostUserIds,  List<ClubHostProfile> hostProfiles, @TimestampConverter()  DateTime createdAt,  String? imageUrl,  String? profileImageUrl,  List<UploadedPhoto> clubPhotos,  UploadedPhoto? logoPhoto,  List<String> tags,  int memberCount,  double rating,  int reviewCount, @NullableTimestampConverter()  DateTime? nextEventAt,  String? nextEventLabel,  String? instagramHandle,  String? phoneNumber,  String? email,  ClubLifecycleStatus status,  bool archived, @NullableTimestampConverter()  DateTime? archivedAt,  String? archiveReason,  ClubAppVisibility appVisibility,  ClubHostDefaults hostDefaults)  $default,) {final _that = this;
switch (_that) {
case _Club():
return $default(_that.id,_that.name,_that.description,_that.location,_that.locationCityId,_that.locationMarketId,_that.area,_that.hostUserId,_that.hostName,_that.hostAvatarUrl,_that.ownerUserId,_that.hostUserIds,_that.hostProfiles,_that.createdAt,_that.imageUrl,_that.profileImageUrl,_that.clubPhotos,_that.logoPhoto,_that.tags,_that.memberCount,_that.rating,_that.reviewCount,_that.nextEventAt,_that.nextEventLabel,_that.instagramHandle,_that.phoneNumber,_that.email,_that.status,_that.archived,_that.archivedAt,_that.archiveReason,_that.appVisibility,_that.hostDefaults);case _:
  throw StateError('Unexpected subclass');
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,description,location,locationCityId,locationMarketId,area,hostUserId,hostName,hostAvatarUrl,ownerUserId,const DeepCollectionEquality().hash(_hostUserIds),const DeepCollectionEquality().hash(_hostProfiles),createdAt,imageUrl,profileImageUrl,const DeepCollectionEquality().hash(_clubPhotos),logoPhoto,const DeepCollectionEquality().hash(_tags),memberCount,rating,reviewCount,nextEventAt,nextEventLabel,instagramHandle,phoneNumber,email,status,archived,archivedAt,archiveReason,appVisibility,hostDefaults]);
