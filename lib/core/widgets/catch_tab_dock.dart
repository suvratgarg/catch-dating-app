...
class CatchTabDockButton<T> extends StatelessWidget {
  const CatchTabDockButton({
    super.key,
    required this.item,
...
class CatchTabDockIcon extends StatelessWidget {
  const CatchTabDockIcon({
    super.key,
    required this.icon,
    required this.color,
    this.badgeCount = 0,
