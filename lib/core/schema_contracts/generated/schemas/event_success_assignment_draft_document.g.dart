...
// JSON Schema constant emitted from firestore/event_success_assignment_drafts.schema.json.

const schemaEventSuccessAssignmentDraftDocumentSchema = <String, Object?>{
  ...
  'properties': <String, Object?>{
    ...
    'baseAssignmentRevision': <String, Object?>{
      'type': 'integer',
      'minimum': 1,
      'maximum': 2147483647,
      'x-catch-ownership': 'callable-owned',
