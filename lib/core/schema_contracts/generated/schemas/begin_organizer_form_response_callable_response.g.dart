...
// JSON Schema constant emitted from callable_responses/begin_organizer_form_response_response.schema.json.

const schemaBeginOrganizerFormResponseCallableResponseSchema = <String, Object?>{
      ...
      'properties': <String, Object?>{
        ...
        'form': <String, Object?>{
          ...
          'properties': <String, Object?>{
            ...
            'availabilityStatus': <String, Object?>{
              'type': 'string',
              'enum': <Object?>[
                'active',
                'notOpen',
            ...
            'availabilityMessage': <String, Object?>{
              'type': <Object?>[
                'string',
                'null',
              ],
