...
/// Resolves app errors and inherited-locale copy for [CatchSliverErrorState].
class CatchLocalizedSliverErrorState extends StatelessWidget {
  const CatchLocalizedSliverErrorState(
    this.error, {
    super.key,
