...
/// Resolves app errors and inherited-locale copy for [CatchInlineErrorState].
class CatchLocalizedInlineErrorState extends StatelessWidget {
  const CatchLocalizedInlineErrorState(
    this.error, {
    super.key,
