...
const gapH28 = SizedBox(height: CatchSpacing.s7);
const gapH32 = SizedBox(height: CatchSpacing.s8);
const gapH36 = SizedBox(height: CatchSpacing.s9);
const gapH40 = SizedBox(height: CatchSpacing.s10);
const gapH44 = SizedBox(height: CatchSpacing.s11);
...
const gapW28 = SizedBox(width: CatchSpacing.s7);
const gapW32 = SizedBox(width: CatchSpacing.s8);
const gapW36 = SizedBox(width: CatchSpacing.s9);
const gapW40 = SizedBox(width: CatchSpacing.s10);
const gapW44 = SizedBox(width: CatchSpacing.s11);
