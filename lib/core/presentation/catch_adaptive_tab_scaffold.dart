...
class CatchAdaptiveTabScaffold extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final navigationBar = keyboardVisible ? null : this.navigationBar;
    final fallback = keyboardVisible ? null : anchoredFallback;
    final tabBarFloats = navigationBar != null && usesFloatingTabLayout;
    final anchoredBar = tabBarFloats ? null : navigationBar ?? fallback;
