...
@JsonKey(includeToJson: false) String get id;@JsonKey(name: 'organizerId', readValue: _readOrganizerId) String get clubId;@TimestampConverter() DateTime get startTime;@TimestampConverter() DateTime get endTime; String get meetingPoint;@JsonKey(includeIfNull: false) EventMeetingLocation? get meetingLocation; double? get startingPointLat; double? get startingPointLng; String? get locationDetails;@JsonKey(includeIfNull: false) String? get photoUrl; List<UploadedPhoto> get eventPhotos; EventFormatSnapshot get eventFormat; double get distanceKm; PaceLevel get pace; int get capacityLimit; String get description; int get priceInPaise; String get currency;@JsonKey(includeIfNull: false) int? get bookedCount;@JsonKey(includeIfNull: false) int? get checkedInCount;@JsonKey(includeIfNull: false) int? get waitlistedCount; int get crossPathsPairHeldCount; int get crossPathsPairConfirmedCount; Map<String, int> get crossPathsPairHeldCohortCounts; EventLifecycleStatus get status;@NullableTimestampConverter() DateTime? get cancelledAt; String? get cancellationReason; EventConstraints get constraints;@JsonKey(includeIfNull: false) EventPolicyBundle? get eventPolicy; Map<String, int> get genderCounts; Map<String, int> get cohortCounts; Map<String, int> get waitlistedCohortCounts;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,clubId,startTime,endTime,meetingPoint,meetingLocation,startingPointLat,startingPointLng,locationDetails,photoUrl,const DeepCollectionEquality().hash(eventPhotos),eventFormat,distanceKm,pace,capacityLimit,description,priceInPaise,currency,bookedCount,checkedInCount,waitlistedCount,crossPathsPairHeldCount,crossPathsPairConfirmedCount,const DeepCollectionEquality().hash(crossPathsPairHeldCohortCounts),status,cancelledAt,cancellationReason,constraints,eventPolicy,const DeepCollectionEquality().hash(genderCounts),const DeepCollectionEquality().hash(cohortCounts),const DeepCollectionEquality().hash(waitlistedCohortCounts)]);

@override
String toString() {
  return 'Event(id: $id, clubId: $clubId, startTime: $startTime, endTime: $endTime, meetingPoint: $meetingPoint, meetingLocation: $meetingLocation, startingPointLat: $startingPointLat, startingPointLng: $startingPointLng, locationDetails: $locationDetails, photoUrl: $photoUrl, eventPhotos: $eventPhotos, eventFormat: $eventFormat, distanceKm: $distanceKm, pace: $pace, capacityLimit: $capacityLimit, description: $description, priceInPaise: $priceInPaise, currency: $currency, bookedCount: $bookedCount, checkedInCount: $checkedInCount, waitlistedCount: $waitlistedCount, crossPathsPairHeldCount: $crossPathsPairHeldCount, crossPathsPairConfirmedCount: $crossPathsPairConfirmedCount, crossPathsPairHeldCohortCounts: $crossPathsPairHeldCohortCounts, status: $status, cancelledAt: $cancelledAt, cancellationReason: $cancellationReason, constraints: $constraints, eventPolicy: $eventPolicy, genderCounts: $genderCounts, cohortCounts: $cohortCounts, waitlistedCohortCounts: $waitlistedCohortCounts)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,clubId,startTime,endTime,meetingPoint,meetingLocation,startingPointLat,startingPointLng,locationDetails,photoUrl,const DeepCollectionEquality().hash(_eventPhotos),eventFormat,distanceKm,pace,capacityLimit,description,priceInPaise,currency,bookedCount,checkedInCount,waitlistedCount,crossPathsPairHeldCount,crossPathsPairConfirmedCount,const DeepCollectionEquality().hash(_crossPathsPairHeldCohortCounts),status,cancelledAt,cancellationReason,constraints,eventPolicy,const DeepCollectionEquality().hash(_genderCounts),const DeepCollectionEquality().hash(_cohortCounts),const DeepCollectionEquality().hash(_waitlistedCohortCounts)]);
