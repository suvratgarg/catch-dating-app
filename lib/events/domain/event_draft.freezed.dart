...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,clubId,savedAt,distance,capacity,price,description,activityKind,paceName,meetingPoint,locationDetails,meetingLocationAddress,meetingLocationPlaceId,startingPointLat,startingPointLng,selectedDateMillis,selectedStartHour,selectedStartMinute,durationMinutes,minAge,maxAge,maxMen,maxWomen,admissionPreset,inviteCode,dynamicPricingEnabled,dynamicPricingStep,dynamicPricingMax,cancellationPolicy,eventSuccessDefaults]);

@override
String toString() {
  return 'EventDraft(id: $id, clubId: $clubId, savedAt: $savedAt, distance: $distance, capacity: $capacity, price: $price, description: $description, activityKind: $activityKind, paceName: $paceName, meetingPoint: $meetingPoint, locationDetails: $locationDetails, meetingLocationAddress: $meetingLocationAddress, meetingLocationPlaceId: $meetingLocationPlaceId, startingPointLat: $startingPointLat, startingPointLng: $startingPointLng, selectedDateMillis: $selectedDateMillis, selectedStartHour: $selectedStartHour, selectedStartMinute: $selectedStartMinute, durationMinutes: $durationMinutes, minAge: $minAge, maxAge: $maxAge, maxMen: $maxMen, maxWomen: $maxWomen, admissionPreset: $admissionPreset, inviteCode: $inviteCode, dynamicPricingEnabled: $dynamicPricingEnabled, dynamicPricingStep: $dynamicPricingStep, dynamicPricingMax: $dynamicPricingMax, cancellationPolicy: $cancellationPolicy, eventSuccessDefaults: $eventSuccessDefaults)';
}
...
class _EventDraft implements EventDraft {
  const _EventDraft({required this.id, required this.clubId, required this.savedAt, this.distance, this.capacity, this.price, this.description, this.activityKind, this.paceName, this.meetingPoint, this.locationDetails, this.meetingLocationAddress, this.meetingLocationPlaceId, this.startingPointLat, this.startingPointLng, this.selectedDateMillis, this.selectedStartHour, this.selectedStartMinute, this.durationMinutes = CatchBusinessRules.eventDefaultDurationMinutes, this.minAge, this.maxAge, this.maxMen, this.maxWomen, this.admissionPreset, this.inviteCode, this.dynamicPricingEnabled = false, this.dynamicPricingStep, this.dynamicPricingMax, this.cancellationPolicy, this.eventSuccessDefaults = const EventSuccessDefaults()});
