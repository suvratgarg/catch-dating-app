...
@useResult
$Res call({
 String id, String clubId, DateTime savedAt, String? distance, String? capacity, String? price, String? description, String? activityKind, String? customActivityLabel, String? interactionModel, String? paceName, String? meetingPoint, String? locationDetails, String? meetingLocationAddress, String? meetingLocationPlaceId, double? startingPointLat, double? startingPointLng, int? selectedDateMillis, int? selectedStartHour, int? selectedStartMinute, int durationMinutes, String? minAge, String? maxAge, String? maxMen, String? maxWomen, String? admissionPreset, String? inviteCode, bool dynamicPricingEnabled, String? dynamicPricingStep, String? dynamicPricingMax, String? cancellationPolicy, EventSuccessDefaults eventSuccessDefaults
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String clubId,  DateTime savedAt,  String? distance,  String? capacity,  String? price,  String? description,  String? activityKind,  String? customActivityLabel,  String? interactionModel,  String? paceName,  String? meetingPoint,  String? locationDetails,  String? meetingLocationAddress,  String? meetingLocationPlaceId,  double? startingPointLat,  double? startingPointLng,  int? selectedDateMillis,  int? selectedStartHour,  int? selectedStartMinute,  int durationMinutes,  String? minAge,  String? maxAge,  String? maxMen,  String? maxWomen,  String? admissionPreset,  String? inviteCode,  bool dynamicPricingEnabled,  String? dynamicPricingStep,  String? dynamicPricingMax,  String? cancellationPolicy,  EventSuccessDefaults eventSuccessDefaults)  $default,) {final _that = this;
switch (_that) {
case _EventDraft():
return $default(_that.id,_that.clubId,_that.savedAt,_that.distance,_that.capacity,_that.price,_that.description,_that.activityKind,_that.customActivityLabel,_that.interactionModel,_that.paceName,_that.meetingPoint,_that.locationDetails,_that.meetingLocationAddress,_that.meetingLocationPlaceId,_that.startingPointLat,_that.startingPointLng,_that.selectedDateMillis,_that.selectedStartHour,_that.selectedStartMinute,_that.durationMinutes,_that.minAge,_that.maxAge,_that.maxMen,_that.maxWomen,_that.admissionPreset,_that.inviteCode,_that.dynamicPricingEnabled,_that.dynamicPricingStep,_that.dynamicPricingMax,_that.cancellationPolicy,_that.eventSuccessDefaults);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String clubId,  DateTime savedAt,  String? distance,  String? capacity,  String? price,  String? description,  String? activityKind,  String? customActivityLabel,  String? interactionModel,  String? paceName,  String? meetingPoint,  String? locationDetails,  String? meetingLocationAddress,  String? meetingLocationPlaceId,  double? startingPointLat,  double? startingPointLng,  int? selectedDateMillis,  int? selectedStartHour,  int? selectedStartMinute,  int durationMinutes,  String? minAge,  String? maxAge,  String? maxMen,  String? maxWomen,  String? admissionPreset,  String? inviteCode,  bool dynamicPricingEnabled,  String? dynamicPricingStep,  String? dynamicPricingMax,  String? cancellationPolicy,  EventSuccessDefaults eventSuccessDefaults)?  $default,) {final _that = this;
switch (_that) {
case _EventDraft() when $default != null:
return $default(_that.id,_that.clubId,_that.savedAt,_that.distance,_that.capacity,_that.price,_that.description,_that.activityKind,_that.customActivityLabel,_that.interactionModel,_that.paceName,_that.meetingPoint,_that.locationDetails,_that.meetingLocationAddress,_that.meetingLocationPlaceId,_that.startingPointLat,_that.startingPointLng,_that.selectedDateMillis,_that.selectedStartHour,_that.selectedStartMinute,_that.durationMinutes,_that.minAge,_that.maxAge,_that.maxMen,_that.maxWomen,_that.admissionPreset,_that.inviteCode,_that.dynamicPricingEnabled,_that.dynamicPricingStep,_that.dynamicPricingMax,_that.cancellationPolicy,_that.eventSuccessDefaults);case _:
  return null;
...
class _EventDraft implements EventDraft {
  const _EventDraft({required this.id, required this.clubId, required this.savedAt, this.distance, this.capacity, this.price, this.description, this.activityKind, this.customActivityLabel, this.interactionModel, this.paceName, this.meetingPoint, this.locationDetails, this.meetingLocationAddress, this.meetingLocationPlaceId, this.startingPointLat, this.startingPointLng, this.selectedDateMillis, this.selectedStartHour, this.selectedStartMinute, this.durationMinutes = CatchBusinessRules.eventDefaultDurationMinutes, this.minAge, this.maxAge, this.maxMen, this.maxWomen, this.admissionPreset, this.inviteCode, this.dynamicPricingEnabled = false, this.dynamicPricingStep, this.dynamicPricingMax, this.cancellationPolicy, this.eventSuccessDefaults = const EventSuccessDefaults()});
