...
@JsonKey(includeToJson: false) String get id; String get eventId; String get clubId; String get organizerId; String get displayName; String get searchName; EventAttendeeSource get source; EventAttendeeStatus get status; String? get linkedUid; String? get phoneE164; String? get email; String? get externalReference; String? get ticketType; String? get importId; String? get sourceRowId; ExternalBookingProvider? get provider; String? get providerConnectionId; String? get providerGuestId;@NullableTimestampConverter() DateTime? get providerSyncedAt; int get providerDataRevision;@TimestampConverter() DateTime get createdAt;@TimestampConverter() DateTime get updatedAt;@NullableTimestampConverter() DateTime? get registeredAt;@NullableTimestampConverter() DateTime? get waitlistedAt;@NullableTimestampConverter() DateTime? get checkedInAt;@NullableTimestampConverter() DateTime? get cancelledAt; String? get checkedInBy;@NullableTimestampConverter() DateTime? get linkedAt; int get attendanceRevision; EventAttendeeStatus? get preCheckInStatus;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,eventId,clubId,organizerId,displayName,searchName,source,status,linkedUid,phoneE164,email,externalReference,ticketType,importId,sourceRowId,provider,providerConnectionId,providerGuestId,providerSyncedAt,providerDataRevision,createdAt,updatedAt,registeredAt,waitlistedAt,checkedInAt,cancelledAt,checkedInBy,linkedAt,attendanceRevision,preCheckInStatus]);

@override
String toString() {
  return 'EventAttendee(id: $id, eventId: $eventId, clubId: $clubId, organizerId: $organizerId, displayName: $displayName, searchName: $searchName, source: $source, status: $status, linkedUid: $linkedUid, phoneE164: $phoneE164, email: $email, externalReference: $externalReference, ticketType: $ticketType, importId: $importId, sourceRowId: $sourceRowId, provider: $provider, providerConnectionId: $providerConnectionId, providerGuestId: $providerGuestId, providerSyncedAt: $providerSyncedAt, providerDataRevision: $providerDataRevision, createdAt: $createdAt, updatedAt: $updatedAt, registeredAt: $registeredAt, waitlistedAt: $waitlistedAt, checkedInAt: $checkedInAt, cancelledAt: $cancelledAt, checkedInBy: $checkedInBy, linkedAt: $linkedAt, attendanceRevision: $attendanceRevision, preCheckInStatus: $preCheckInStatus)';
}
