...
_EventDraft _$EventDraftFromJson(Map<String, dynamic> json) => _EventDraft(
  ...
  eventCityId: json['eventCityId'] as String?,
  eventMarketId: json['eventMarketId'] as String?,
  eventLocalDate: json['eventLocalDate'] as String?,
  eventLocalStartTime: json['eventLocalStartTime'] as String?,
  eventTimezone: json['eventTimezone'] as String?,
  eventCityMode: json['eventCityMode'] as String?,
  eventTimezoneMode: json['eventTimezoneMode'] as String?,
  eventReviewedDefaultsHash: json['eventReviewedDefaultsHash'] as String?,
  eventCreateRequestId: json['eventCreateRequestId'] as String?,
  eventCreatePayloadSignature: json['eventCreatePayloadSignature'] as String?,
  eventCreatePayloadJson: json['eventCreatePayloadJson'] as String?,
  eventCreateReceiptEventId: json['eventCreateReceiptEventId'] as String?,
  eventCreateReceiptRevision: (json['eventCreateReceiptRevision'] as num?)
      ?.toInt(),
...
Map<String, dynamic> _$EventDraftToJson(_EventDraft instance) =>
    <String, dynamic>{
      ...
      'eventMarketId': instance.eventMarketId,
      'eventLocalDate': instance.eventLocalDate,
      'eventLocalStartTime': instance.eventLocalStartTime,
      'eventTimezone': instance.eventTimezone,
      'eventCityMode': instance.eventCityMode,
      'eventTimezoneMode': instance.eventTimezoneMode,
      'eventReviewedDefaultsHash': instance.eventReviewedDefaultsHash,
      'eventCreateRequestId': instance.eventCreateRequestId,
      'eventCreatePayloadSignature': instance.eventCreatePayloadSignature,
      'eventCreatePayloadJson': instance.eventCreatePayloadJson,
      'eventCreateReceiptEventId': instance.eventCreateReceiptEventId,
      'eventCreateReceiptRevision': instance.eventCreateReceiptRevision,
