    ...
    final basics = [
      ...
      ProfileInfoEntry(
        ...
        onTap: () => showTextEditSheet(
          ...
          applyEdit: (u, v) => u.copyWith(email: v),
        ),
    ...
    final location = [
      ProfileInfoEntry(
        ...
        onTap: () => showSingleEnumSheet<IndianCity>(
          ...
          applyEdit: (u, v) => u.copyWith(city: v),
        ),
    ...
    final running = [
      ...
      ProfileInfoEntry(
        ...
        onTap: () => showMultiEnumSheet<PreferredDistance>(
          ...
          applyEdit: (u, v) => u.copyWith(preferredDistances: v),
        ),
      ...
      ProfileInfoEntry(
        ...
        onTap: () => showMultiEnumSheet<RunReason>(
          ...
          applyEdit: (u, v) => u.copyWith(runningReasons: v),
        ),
    ...
    final notifications = [
      ProfileInfoEntry(
        ...
        onTap: () => showBooleanEditSheet(
          ...
          applyEdit: (u, v) => u.copyWith(prefsNewCatches: v),
        ),
      ),
      ProfileInfoEntry(
        ...
        onTap: () => showBooleanEditSheet(
          ...
          applyEdit: (u, v) => u.copyWith(prefsRunReminders: v),
        ),
      ),
      ProfileInfoEntry(
        ...
        onTap: () => showBooleanEditSheet(
          ...
          applyEdit: (u, v) => u.copyWith(prefsWeeklyDigest: v),
        ),
      ),
      ProfileInfoEntry(
        ...
        onTap: () => showBooleanEditSheet(
          ...
          applyEdit: (u, v) => u.copyWith(prefsShowOnMap: v),
        ),
      ),
    ];
