export const publicFormsCopy = {
  ...
  phoneOtherCountry: "Other country code",
  phoneNationalPlaceholder: "98765 43210",
  editPhone: "Edit number",
  phoneVerificationHelp: "Verify now to bring in your saved Catch details. You can keep filling the form while the code arrives.",
  phoneVerificationRequired: "Verify your mobile number before submitting. Your answers are still here.",
  ...
  messagingPhoneRequired: "WhatsApp choices need a mobile number on this form or a verified phone sign-in. If neither is available, leave these boxes unchecked; you can still submit your response.",
