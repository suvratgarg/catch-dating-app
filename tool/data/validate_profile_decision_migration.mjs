...
function printHelp() {
  console.log(`Usage: node tool/data/validate_profile_decision_migration.mjs [options]

Dry-event validator for the legacy swipes -> profileDecisions storage rename.
