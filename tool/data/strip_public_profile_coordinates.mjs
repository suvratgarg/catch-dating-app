...
function printHelp() {
  console.log(`
Usage:
  node tool/data/strip_public_profile_coordinates.mjs --env dev
  node tool/data/strip_public_profile_coordinates.mjs --env dev --apply
  node tool/data/strip_public_profile_coordinates.mjs --env prod --apply --allow-prod
