...
const forbiddenSourceMarkers = [
  ...
  ["lib/clubs/data", "organizer_projection_fallback"],
  ["lib/clubs/data/clubs_repository.dart", "_legacyCollectionPath"],
  ["lib/clubs/data/clubs_repository.dart", "WithLegacyProjection"],
