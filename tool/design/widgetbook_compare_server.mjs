  ...
  const firstPassConsolidationGroups = [
    ...
    },
    {
      ...
      names: [
        ...
        "CompanionPaperProgressIndicator",
      ],
    },
    {
    ...
    },
    {
      ...
      tags: ["live", "host"],
      names: [
        "EventSuccessControlRoomPageBody",
        "LiveCheckInQrCard",
        "LiveAttendanceSummaryCard",
        "LiveCheckInSummaryStrip",
        "CompanionArrivalProgressIndicator",
        "LiveStepContextCard",
