...
contracts, route inventory, capture coverage, screen coverage, screen
contracts, state matrix, and Widgetbook references. Advisory checks print known
screen-contract migration debt without failing the gate.`);
}
