...
import {hasWidgetbookReviewSource} from "./widgetbook_compare_server.mjs";
...
test("Widgetbook comparison keeps derived snapshots out of trunk", () => {
  ...
  assert.doesNotMatch(
    snapshot.readText("tool/design/widgetbook_compare_server.mjs", {
      required: true,
    }),
    /widgetbook_coverage_report/u,
  );
});
