export const taskCommandTemplates = Object.freeze({
  start: "node tool/harness.mjs task start --task-id <task-id> --base-sha <40-character-sha> --stack-parent <ref> --paths <path[,path...]> --context-pack <pack.json> [--budget-mib 256]",
