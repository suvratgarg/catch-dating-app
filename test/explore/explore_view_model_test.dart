...
CrossPathsSuggestion _crossPathsSuggestion({
  required String uid,
...
void main() {
  group('Explore state', () {
    ...
    test(
      'Cross Paths callable context includes only booked or bookable events',
      () {
        final club = buildClub(id: 'cross-paths-context-club');
    ...
    test('second organizer stays outside the first eight mixed cards', () {
      ...
      expect(
        eightEventCards.whereType<ExploreMixedClubRowCard>(),
        hasLength(1),
      );
    ...
    test(
      'Cross Paths keeps the first eight event-majority and separates people',
      () {
        final eventClub = buildClub(id: 'cross-paths-event-club');
        final clubs = [
          buildClub(id: 'cross-paths-organizer-1', nextEventLabel: 'Friday'),
          buildClub(id: 'cross-paths-organizer-2', nextEventLabel: 'Saturday'),
        ];
        final starts = [
        ...
        expect(
          firstEight.whereType<ExploreMixedClubSpotlightCard>(),
          hasLength(1),
        );
