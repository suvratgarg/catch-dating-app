...
void main() {
  ...
  group('Run clubs flow', () {
    ...
    testWidgets('detail screen can load from live data without navigation extra', (
      tester,
    ) async {
      final club = _buildClub();
    ...
    testWidgets('detail screen refreshes membership UI when the club stream updates', (
      tester,
    ) async {
      final club = _buildClub();
