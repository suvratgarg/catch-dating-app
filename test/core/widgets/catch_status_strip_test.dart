...
void main() {
      ...
      for (final tabbed in [false, true]) {
        testWidgets(
          ...
          (tester) async {
            ...
            await tester.pump();
            final expectedTop = tabbed ? 59.0 + 44 : 59.0;
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(
        tester.getTopLeft(find.byKey(_body)).dy,
        tester.getBottomLeft(find.byKey(_offline)).dy + 24,
      );
        ...
        return RepaintBoundary(
          ...
          child: MediaQuery(
            ...
            child: CatchStatusStripScope(
              statuses: [if (!tabbed && !pushed) ...local, ...global],
              child: pushed
                  ? CatchRouteScaffold(
                      statuses: local,
                      ...
                      child: Builder(
                        builder: (context) {
                          ...
                          return CatchTabbedScreenScaffold(
                            title: 'Organizer',
                            statuses: local,
                            outerScrollController: controller,
                            tabRail: CatchTabControllerRail<int>(
                              key: _rail,
                              controller: tabs,
                              options: const [
