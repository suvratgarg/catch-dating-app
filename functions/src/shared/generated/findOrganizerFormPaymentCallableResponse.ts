...
/**
 * Owner-only latest payment projection; does not start checkout or depend on the current form version or availability.
 */
export interface FindOrganizerFormPaymentCallableResponse {
  payment: {
    paymentId: string;
    status:
      | "creatingOrder"
