...
/**
 * Callable payload accepted by adminUpdateOrganizerDetails. This edits owner-safe organizer listing fields through an audited admin callable.
 */
export interface AdminUpdateOrganizerDetailsCallablePayload {
  organizerId: string;
  fields: {
    name?: string;
    description?: string;
