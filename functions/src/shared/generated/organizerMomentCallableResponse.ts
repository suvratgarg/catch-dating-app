...
/**
 * Single-moment response for upsert/arm/pause/resume.
 */
export interface OrganizerMomentCallableResponse {
  /**
   * The full moment definition returned by moment callables.
   */
  moment: {
    momentId: string;
    scope: {
