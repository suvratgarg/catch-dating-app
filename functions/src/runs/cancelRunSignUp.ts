...
const defaultDeps: CancelRunSignUpDeps = {
 ...
 * @param {CancelRunSignUpDeps} deps Injectable dependencies.
 * @return {Promise<{cancelled: boolean}>} Operation result.
 */
export async function cancelRunSignUpHandler(
  request: CallableRequest<unknown>,
  deps: CancelRunSignUpDeps = defaultDeps
  ...
  await deps.checkRateLimit(db, userId, "cancelRunSignUp");
...
export const cancelRunSignUp = onCall(
  ...
  async (request) => cancelRunSignUpHandler(request)
);
