...
function buildEventDoc(
  ...
  return {
    ...
    startingPointLat: 40.6602,
    startingPointLng: -73.9690,
...
function buildClubDoc(overrides: Partial<ClubDocument> = {}): ClubDocument {
  return {
    ...
    locationCityId: "us-ny-new-york",
    locationMarketId: "us-ny-new-york",
    area: "Brooklyn",
    hostUserId: "host-1",
    hostName: "Host",
    hostAvatarUrl: null,
...
function buildHostAccountDoc(
  ...
  return {
    ...
    country: "US",
    defaultCurrency: "USD",
    providerAccountId: "acct_host_123",
    stripeAccountId: "acct_host_123",
    razorpayAccountId: "",
    chargesEnabled: true,
    payoutsEnabled: true,
