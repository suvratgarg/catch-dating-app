...
| `getEventAssistanceAccountability` / `resolveEventAssistanceAccountability` | `src/eventSuccess/operations/accountabilityHandlers.ts` | Current-visit sweep resolution using the shared attendee record and revision; organizer managers and current scoped lead/pacer/sweep duties, with accepted group membership and immutable retry receipts. |
