...
| `getEventAssistanceGroupProgress` / `confirmEventAssistanceDeparture` | `src/eventSuccess/operations/groupProgressHandlers.ts` | Organizer-manager read and revision-fenced departure confirmation against saved event destinations; no message sending or attendance mutation |
