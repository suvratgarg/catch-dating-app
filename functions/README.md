...
| `getEventAssistanceGroupProgress` / `confirmEventAssistanceDeparture` | `src/eventSuccess/operations/groupProgressHandlers.ts` | Scoped staff/manager read and lead/pacer revision-fenced departure confirmation against saved event destinations; no message sending or attendance mutation |
