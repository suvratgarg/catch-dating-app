...
route-by-route product requirements remain in
`docs/admin_dashboard_user_stories_and_component_catalogue.md`; active work is
tracked in GitHub Issues rather than a repository adoption ledger.
