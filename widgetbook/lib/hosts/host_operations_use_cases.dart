...
import 'package:catch_dating_app/core/widgets/catch_form_review_body.dart';
    ...
    children: [
      _StateCard(
        ...
        child: const _DeviceFrame(
          child: _HostShellScope(uid: null, child: HostTodayScreen()),
        ),
      ),
      _StateCard(
        label: 'clubs loading',
      ...
      _StateCard(
        ...
        child: const _DeviceFrame(
          child: _HostShellScope(child: HostTodayScreen()),
        ),
      ),
      _StateCard(
  ...
  return _HostCatalog(
    ...
    children: const [
      _StateCard(
        ...
        child: _DeviceFrame(
          child: _HostShellScope(child: _HostPaymentSectionStates()),
        ),
      ),
      _StateCard(
