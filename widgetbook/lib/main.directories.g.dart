          ...
          _widgetbook.WidgetbookComponent(
            ...
            useCases: [
              _widgetbook.WidgetbookUseCase(
                name: 'Catalog states',
                builder: _widgetbook_workspace_primitives_core_catalog_use_cases
                    .catchFieldCommitButtonCatalogStates,
              ),
            ],
          ),
          _widgetbook.WidgetbookComponent(
            ...
            useCases: [
              _widgetbook.WidgetbookUseCase(
                name: 'Catalog states',
                builder: _widgetbook_workspace_primitives_core_catalog_use_cases
                    .catchFieldRepeatButtonCatalogStates,
              ),
            ],
          ),
          _widgetbook.WidgetbookComponent(
    ...
    children: [
          ...
          _widgetbook.WidgetbookComponent(
            ...
            useCases: [
              _widgetbook.WidgetbookUseCase(
                ...
                builder:
                    _widgetbook_workspace_primitives_primitive_contract_use_cases
                        .chatComposerContractStates,
              ),
              _widgetbook.WidgetbookUseCase(
                name: 'Focused draft',
                builder:
                    _widgetbook_workspace_primitives_primitive_contract_use_cases
                        .chatComposerFocusedDraft,
              ),
              _widgetbook.WidgetbookUseCase(
                name: 'Focused empty',
                builder:
                    _widgetbook_workspace_primitives_primitive_contract_use_cases
                        .chatComposerFocusedEmpty,
              ),
            ],
          ),
          _widgetbook.WidgetbookComponent(
      ...
      _widgetbook.WidgetbookFolder(
        ...
        children: [
          ...
          _widgetbook.WidgetbookComponent(
            name: 'CatchChipRemoveButton',
            useCases: [
              _widgetbook.WidgetbookUseCase(
                name: 'Contract states',
                builder:
                    _widgetbook_workspace_primitives_primitive_contract_use_cases
                        .catchChipRemoveButtonContractStates,
              ),
            ],
          ),
          _widgetbook.WidgetbookComponent(
          ...
          _widgetbook.WidgetbookComponent(
            name: 'CatchSegmentButton',
            useCases: [
              _widgetbook.WidgetbookUseCase(
                name: 'Contract states',
                builder:
                    _widgetbook_workspace_primitives_primitive_contract_use_cases
                        .catchSegmentButtonContractStates,
              ),
            ],
          ),
          _widgetbook.WidgetbookComponent(
        ...
        children: [
          ...
          _widgetbook.WidgetbookFolder(
            ...
            children: [
              ...
              _widgetbook.WidgetbookComponent(
                name: 'HostEventLifecycleDateBlock',
                useCases: [
                  _widgetbook.WidgetbookUseCase(
                    name: 'Exact catalog',
                    builder:
                        _widgetbook_workspace_hosts_host_operations_use_cases
                            .hostStrictHostEventLifecycleDateBlockCatalogStates,
                  ),
                ],
              ),
              _widgetbook.WidgetbookComponent(
