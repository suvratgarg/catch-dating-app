...
- Screen registry migration gaps: 50 open, 15 blocked, and 74 closed. These are
...
- Design parity matrix: 12 feature groups, 36 screens, 621 matrix states, and
  66 open matrix gaps across screen-state, lint-candidate, and preview-plan
  queues.
...
| P2 | `screen.filters.preferences` | 11 | 5 | 1 | None | `DS-FILTERS-001`, `DS-FILTERS-002` | FiltersPreferencesState now owns saved defaults, draft values, dirty state, reset/apply availability, pending state, and save request fields; continue save-error proof, captures, and visual parity. |
...
- [ ] `filters.preferences` (10 state follow-ups, 2 open gaps)
  - planned: `text_scale_2`
