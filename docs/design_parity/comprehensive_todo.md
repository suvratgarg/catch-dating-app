...
- [ ] `onboarding.flow` (13 state follow-ups, 2 open gaps)
  - planned: None
  - implemented: `OnboardingFlowState`, `OnboardingTopBarState`, `OnboardingNameDobState`, `OnboardingNameDobStep`, `OnboardingPhotosState`, `OnboardingPhotosStep`
  - tested: `required_field_errors`, `name_dob_step_adapter`, `photos_upload_failure`, `photos_step_adapter`, `save_profile_mutation`, `complete_mutation`
