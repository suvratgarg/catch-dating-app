...
- Screen registry migration gaps: 51 open, 15 blocked, and 73 closed. These are
...
- Design parity matrix: 12 feature groups, 36 screens, 621 matrix states, and
  67 open matrix gaps across screen-state, lint-candidate, and preview-plan
  queues.
...
| P2 | `screen.calendar.home` | 10 | 5 | 0 | Blocked: no standalone Calendar Home source; only `CalendarPrimitive.html`/`DateRangePicker` | `DS-CALENDAR-001`, `DS-CALENDAR-002`, `DS-CALENDAR-004` blocked | CalendarHomeState and CalendarAgendaSectionState own summary/header/agenda/state adapters; continue Widgetbook, deterministic captures, and reference export once a canonical screen source exists. |
...
- [ ] `calendar.home` (10 state follow-ups, 2 open gaps)
