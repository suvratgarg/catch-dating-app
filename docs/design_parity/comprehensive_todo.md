...
- [ ] `onboarding.flow` (13 state follow-ups, 2 open gaps)
  - planned: None
  - implemented: None
  - tested: `required_field_errors`, `photos_upload_failure`, `save_profile_mutation`, `complete_mutation`
