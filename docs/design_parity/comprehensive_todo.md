...
- Feature orchestration coverage: 57 registered authorities, 19 source
  contracts, 23 contracted Flutter screens, 2 contracted marketing routes, and
  9 planned Flutter screens. The social-journey batch compiles all 99
...
- Screen registry migration gaps: 18 open, 24 blocked, and 99 closed. One of
  the 18 non-blocked gaps is currently marked in progress. These are
