...
- Feature orchestration coverage: 57 registered authorities, 15 source
  contracts, 16 contracted Flutter screens, 2 contracted marketing routes, and
  16 planned Flutter screens. The social-journey batch compiles all 99
...
- Screen registry migration gaps: 11 open, 24 blocked, and 99 closed. These are
