...
- Feature orchestration coverage: 57 registered authorities, 16 source
  contracts, 18 contracted Flutter screens, 2 contracted marketing routes, and
  14 planned Flutter screens. The social-journey batch compiles all 99
...
- Screen registry migration gaps: 15 open, 24 blocked, and 99 closed. These are
