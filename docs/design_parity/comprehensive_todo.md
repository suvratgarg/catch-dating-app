...
- Feature orchestration coverage: 57 registered authorities, 14 source
  contracts, 15 contracted Flutter screens, 2 contracted marketing routes, and
  17 planned Flutter screens. The social-journey batch compiles all 99
...
- Screen registry migration gaps: 10 open, 24 blocked, and 99 closed. These are
...
- Design parity matrix: 12 feature groups, 33 screens, 599 matrix states, and
  45 open matrix gaps across screen-state, lint-candidate, and preview-plan
  queues.
