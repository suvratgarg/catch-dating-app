...
- [ ] `onboarding.flow` (13 state follow-ups, 2 open gaps)
  - planned: None
  - implemented: `OnboardingFlowState`, `OnboardingTopBarState`, `OnboardingPhotosState`, `OnboardingPhotosStep`
  - tested: `required_field_errors`, `photos_upload_failure`, `photos_step_adapter`, `save_profile_mutation`, `complete_mutation`
