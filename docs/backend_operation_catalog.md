...
| `getOrganizerContactDetail` | Callable | Host Audience person detail | One restricted contact, traits and at most 100 contact-event edges | App-Check-protected, rate-limited and manager-only. Cross-organizer or merged/deleted ids return not-found. The timeline returns operational attendance facts and never private questionnaire, wingman, compatibility, feedback or safety content. |
