...
|---|---|---|---|
| `publicProfiles/{uid}.name`, `photoUrls`, `photoThumbnailUrls`, and public profile fields | `users/{uid}` | `syncPublicProfile` | Firestore trigger plus `tool/validate_firestore_data.mjs` profile checks. |
