...
| `organizerContacts`, `organizerContactIdentityLinks`, `organizerContactIdentityClaims`, `organizerContactEventEdges`, `organizerContactTraits` | Organizer audience projection and future manager-only CRM callables | Server-only; raw contact, identity evidence and traits never have direct client collection access. |
