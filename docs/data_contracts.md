...
| Tool-side schema registry and validators | `tool/generated/` |
| Firestore operation ownership metadata | `tool/firestore_contract.json` |
| Transitional Admin SDK facade | `functions/src/shared/firestore.ts` generated by `dart tool/generate_firestore_types.dart` |
...
- `tool/validate_firestore_data.mjs` validates edge documents and parent
