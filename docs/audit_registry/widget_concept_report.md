...
| Production widget/state classes | — | 1102 | Exhaustive generated inventory. |
...
| 6. Report concept and class counts separately | proven | 63 concepts, 198 contracted public classes, 1102 production widget/state classes |
