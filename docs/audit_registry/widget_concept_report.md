...
| Production widget/state classes | — | 1106 | Exhaustive generated inventory. |
...
| Public composition widget classes | — | 518 | Excluded from concept count. |
...
| 6. Report concept and class counts separately | proven | 63 concepts, 198 contracted public classes, 1106 production widget/state classes |
