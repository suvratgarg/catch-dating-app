...
| Production widget/state classes | — | 1118 | Exhaustive generated inventory. |
...
| 6. Report concept and class counts separately | proven | 65 concepts, 203 contracted public classes, 1118 production widget/state classes |
