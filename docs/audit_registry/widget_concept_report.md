...
| Contracted public widget classes | — | 203 | Primaries and members are counted separately from concepts. |
...
| Production widget/state classes | — | 1116 | Exhaustive generated inventory. |
...
| Public screen widget classes | — | 272 | Excluded from concept count. |
...
| Ranked pairs covered by a ledger decision | 141/200 |
| Unresolved ranked pairs | 59 |
...
| 6. Report concept and class counts separately | proven | 65 concepts, 203 contracted public classes, 1116 production widget/state classes |
...
| 8. Reduce remaining work to a bounded queue | proven | 3 generated owner/live gates and 59 advisory ranked-pair candidates |
