...
|---|---:|---:|---|
| Top-level contract entries | 64 | 68 | Contracts may remain useful without claiming concept identity. |
| Independent concepts | 64 proxy | 62 | 2 fewer than the old top-level proxy (3.13%); count accuracy, not reduction, is the objective. |
| Contracted public widget classes | — | 194 | Primaries and members are counted separately from concepts. |
| Member APIs | — | 115 (1.85 per concept) | Public seams do not inflate concept count. |
| Unclassified contracted entries | — | 0 | Must remain zero. |
| Production widget/state classes | — | 1094 | Exhaustive generated inventory. |
| Instantiated concept primaries | — | 61 | One contracted primary is not a runtime Widget declaration. |
| Public member widget classes | — | 113 | Role is inherited from the component contract. |
...
| Widgetbook-complete concept primaries | — | 61/61 | Evidence is role-derived. |
| Widgetbook-covered member classes | — | 113/113 | Reviewed directly or under the parent family. |
...
| Ranked pairs covered by a ledger decision | 146/200 |
| Unresolved ranked pairs | 54 |
| Ledger decisions indexed | 314 |
...
| Code Connect planned contracts | 68 |
| Claude-allowed contracts | 68 |
...
| 6. Report concept and class counts separately | proven | 62 concepts, 194 contracted public classes, 1094 production widget/state classes |
...
| 8. Reduce remaining work to a bounded queue | proven | 3 generated owner/live gates and 54 advisory ranked-pair candidates |
