...
| Cross Paths | `cross_paths.md` | Approved people-in-Explore, consent, showcase-readiness, invitation, temporary event-plan, capacity, privacy, ranking, analytics, and phased-delivery contract. |
