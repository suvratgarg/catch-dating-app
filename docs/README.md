...
| Test architecture and lifecycle | `../TESTS.md`, `audit_registry/test_inventory.json`, `audit_registry/test_lifecycle.json` | Canonical suite commands, behavioral ownership policy, exhaustive executable-test inventory, exceptional-test review/sunset metadata, and critical source-to-test obligations. |
