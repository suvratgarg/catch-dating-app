...
|---|---|---|
| Screen composition | Every full-screen composition terminates in `CatchScaffold.standalone`, `.stepFlow`, or `.workspace`; only that primitive constructs Material `Scaffold`. Root title destinations use the closed `.standard` or `.fullBleed` role on `CatchRootScreenScaffold` / `CatchRootScreenScrollView`; roots with pinned peer navigation use `.withPrimaryRail` plus `CatchRootScreenPageScrollView`; pushed routes use `CatchRouteScaffold`, and those higher-level owners delegate to the canonical surface. Standard roots jointly select the 20 pt phone gutter, 16 pt body start, responsive content lane, and terminal shell clearance; full bleed keeps clearance while delegating edge geometry. The composition gate verifies the declared constructor role and branch-universal analyzer proof across every statically reachable widget-producing terminal. It globally discovers every full-screen `PageRoute` form; only direct `MaterialPageRoute` construction is inventory-supported, so aliases, wrappers, tear-offs, alternative builders, and subclasses fail closed. Focused tests remain responsible for executing runtime predicates and redirect results. | Do not compose a feature-local `Scaffold` + `SafeArea` + `CustomScrollView` + title padding + terminal spacer, add another compact body role, or copy numeric body gaps between screens. |
...
1079 public production Widgets. Source discovery determines membership; the component registry supplies reviewed identity and ladder metadata.

Purpose comes from the first class documentation paragraph, then the registry summary. 782 declarations have neither and remain visible as undocumented. Unreviewed feature Widgets use the existing screen-name boundary for L5/L6; that source classification is not a semantic conformance verdict.
...
| <code>CatchRowPressSurface</code> | <code>packages/catch_ui/lib/src/primitives/catch_row_press_surface.dart:10</code> | <code>Surface</code> | <code>catch.row_press_surface</code> | Full-row interaction layer for list and field rows. |
...
| <code>CatchButton</code> | <code>packages/catch_ui/lib/src/components/catch_button.dart:30</code> | <code>Button</code> | <code>catch.button</code> | Canonical labelled action with command, selection and floating recipes. |
...
| <code>CatchFieldSurface</code> | <code>packages/catch_ui/lib/src/components/catch_field_surface.dart:14</code> | <code>Surface</code> | <code>catch.field</code> | Field state paint: row backgrounds and the focus ring of a small target. |
...
| <code>CatchPersonRow</code> | <code>packages/catch_ui/lib/src/components/catch_person_row.dart:38</code> | <code>Row</code> | <code>catch.person_row</code> | Flexible person row used in: - **Chat inbox** — pass [data.lastMessage] to activate chat-thread layout - **Roster / waitlist** — leave [data.lastMessage] null, pass [trailing] - **Catches preview** — similar to roster; pass a badge as [trailing] |
...
| <code>CatchRecordRow</code> | <code>packages/catch_ui/lib/src/components/catch_record_row.dart:14</code> | <code>Row</code> | <code>catch.record_row</code> | A readable record: heading, optional evidence/context, and optional prose. |
...
| <code>CatchSection</code> | <code>packages/catch_ui/lib/src/components/catch_section.dart:29</code> | <code>Section</code> | <code>catch.section</code> | Design-system `Section`: the canonical primitive for grouping information. |
...
| <code>CatchMasterDetailViewport</code> | <code>packages/catch_ui/lib/src/patterns/catch_master_detail_viewport.dart:9</code> | <code>Viewport</code> | <code>catch.screen_body</code> | Index/detail pane geometry with explicit or local-width split selection. |
...
| <code>CatchScaffold</code> | <code>packages/catch_ui/lib/src/patterns/catch_scaffold.dart:16</code> | <code>Scaffold</code> | <code>catch.screen_body</code> | Canonical surface owner for full-screen compositions. |
| <code>CatchScreenSkeleton</code> | <code>packages/catch_ui/lib/src/patterns/catch_screen_skeleton.dart:8</code> | <code>Skeleton</code> | <code>catch.skeleton</code> | Screen-body loading placement with standard insets and optional scrolling. |
...
| <code>CatchSectionList</code> | <code>packages/catch_ui/lib/src/patterns/catch_section_list.dart:23</code> | <code>SectionList</code> | <code>catch.section_stack</code> | Ordered section rhythm with inset, sliver, responsive and page recipes. |
| <code>CatchSkeleton</code> | <code>packages/catch_ui/lib/src/patterns/catch_skeleton.dart:34</code> | <code>Skeleton</code> | <code>catch.skeleton</code> | Skeleton loading placeholders with a shimmer animation. |
...
| <code>CatchSliverSkeleton</code> | <code>packages/catch_ui/lib/src/patterns/catch_sliver_skeleton.dart:7</code> | <code>Skeleton</code> | <code>catch.skeleton</code> | Sliver loading placement with caller-owned page padding. |
| <code>CatchStateViewport</code> | <code>packages/catch_ui/lib/src/patterns/catch_state_viewport.dart:9</code> | <code>Viewport</code> | <code>catch.empty_state</code> | Removes the floating shell obstruction from terminal-state placement. |
...
| <code>ChatConversationsList</code> | <code>lib/chats/presentation/inbox/widgets/chat_conversations_list.dart:13</code> | — | — | No class documentation or registry summary. |
...
| <code>ClubDetailLoadingBody</code> | <code>lib/clubs/presentation/detail/widgets/club_detail_skeleton.dart:8</code> | — | — | Skeleton loading body for the club detail screen. |
| <code>ClubDetailLoadingSliverBody</code> | <code>lib/clubs/presentation/detail/widgets/club_detail_skeleton.dart:23</code> | — | — | Sliver-native form of the canonical Club Detail loading composition. |
| <code>ClubHeroLoadingSkeleton</code> | <code>lib/clubs/presentation/detail/widgets/club_detail_skeleton.dart:65</code> | — | — | No class documentation or registry summary. |
| <code>ClubHostLoadingSkeleton</code> | <code>lib/clubs/presentation/detail/widgets/club_detail_skeleton.dart:167</code> | — | — | No class documentation or registry summary. |
| <code>ClubScheduleLoadingSkeleton</code> | <code>lib/clubs/presentation/detail/widgets/club_detail_skeleton.dart:210</code> | — | — | No class documentation or registry summary. |
| <code>ClubStatLoadingSkeleton</code> | <code>lib/clubs/presentation/detail/widgets/club_detail_skeleton.dart:135</code> | — | — | No class documentation or registry summary. |
| <code>ClubStatsDividerSkeleton</code> | <code>lib/clubs/presentation/detail/widgets/club_detail_skeleton.dart:151</code> | — | — | No class documentation or registry summary. |
| <code>ClubStatsLoadingSkeleton</code> | <code>lib/clubs/presentation/detail/widgets/club_detail_skeleton.dart:110</code> | — | — | No class documentation or registry summary. |
| <code>ClubTextLoadingSkeleton</code> | <code>lib/clubs/presentation/detail/widgets/club_detail_skeleton.dart:199</code> | — | — | No class documentation or registry summary. |
...
| <code>MembershipTrailing</code> | <code>lib/clubs/presentation/discovery/widgets/club_list_tile_parts/directory_card.dart:182</code> | — | — | No class documentation or registry summary. |
...
| <code>CrossPathsProfilePreviewSheet</code> | <code>lib/cross_paths/presentation/cross_paths_explore_card.dart:236</code> | — | — | No class documentation or registry summary. |
| <code>ActivityScreenBody</code> | <code>lib/dashboard/presentation/activity_screen.dart:180</code> | — | — | No class documentation or registry summary. |
| <code>ActivityScreenLoading</code> | <code>lib/dashboard/presentation/activity_screen.dart:168</code> | — | — | No class documentation or registry summary. |
| <code>DashboardFocusLoadingCard</code> | <code>lib/dashboard/presentation/dashboard_screen.dart:217</code> | — | — | No class documentation or registry summary. |
| <code>DashboardLoadingHeader</code> | <code>lib/dashboard/presentation/dashboard_screen.dart:186</code> | — | — | No class documentation or registry summary. |
| <code>NotificationsAction</code> | <code>lib/dashboard/presentation/dashboard_screen.dart:145</code> | — | — | No class documentation or registry summary. |
...
| <code>ClubPostHomeCard</code> | <code>lib/dashboard/presentation/widgets/club_posts_home_section.dart:54</code> | — | — | No class documentation or registry summary. |
| <code>ClubPostsHomeSection</code> | <code>lib/dashboard/presentation/widgets/club_posts_home_section.dart:10</code> | — | — | No class documentation or registry summary. |
...
| <code>DashboardFullSliverBody</code> | <code>lib/dashboard/presentation/widgets/dashboard_full.dart:31</code> | — | — | No class documentation or registry summary. |
...
| <code>EventCheckInQrScannerSheet</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_live_cards.dart:683</code> | — | — | No class documentation or registry summary. |
| <code>GroupRotationSlotRow</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_live_cards.dart:145</code> | — | — | No class documentation or registry summary. |
| <code>IncludeMeToggle</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_live_cards.dart:534</code> | — | — | No class documentation or registry summary. |
| <code>LiveStepContextCard</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_live_cards.dart:375</code> | — | — | No class documentation or registry summary. |
...
| <code>PeopleTokenRow</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_live_cards.dart:998</code> | — | — | No class documentation or registry summary. |
| <code>PreCheckInPlanningCard</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_live_cards.dart:422</code> | — | — | Informational preview of what the host will guide the attendee through once check-in opens. Opt-out controls live on the at-event cards instead. |
| <code>PreviewLine</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_live_cards.dart:511</code> | — | — | No class documentation or registry summary. |
| <code>RotationScheduleCard</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_live_cards.dart:222</code> | — | — | No class documentation or registry summary. |
| <code>RotationSlotRow</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_live_cards.dart:324</code> | — | — | No class documentation or registry summary. |
| <code>SelfCheckInCard</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_live_cards.dart:578</code> | — | — | No class documentation or registry summary. |
| <code>StageConversationCueCard</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_live_cards.dart:848</code> | — | — | No class documentation or registry summary. |
| <code>StageCueLine</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_live_cards.dart:890</code> | — | — | No class documentation or registry summary. |
| <code>StagePromptCard</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_live_cards.dart:822</code> | — | — | No class documentation or registry summary. |
| <code>StageSectionLabel</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_live_cards.dart:967</code> | — | — | No class documentation or registry summary. |
...
| <code>AnimatedStageMotifBackground</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:1454</code> | — | — | Plays the portable stage asset on the idle-pulse period owned by the generated moment contract. |
| <code>ArrivalRingCard</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:1834</code> | — | — | No class documentation or registry summary. |
| <code>CompanionHero</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:1033</code> | — | — | No class documentation or registry summary. |
| <code>CompanionMomentStage</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:848</code> | — | — | No class documentation or registry summary. |
| <code>CompanionMomentStageContent</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:1239</code> | — | — | No class documentation or registry summary. |
| <code>CompanionPaperScaffold</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:113</code> | — | — | No class documentation or registry summary. |
| <code>CompanionStageContentTransition</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:1538</code> | — | — | No class documentation or registry summary. |
| <code>CompanionStageScaffold</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:23</code> | — | — | No class documentation or registry summary. |
| <code>LiveArrivalRing</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:1753</code> | — | — | Live co-presence ring shown on arrival-class moments. Reads `Event.checkedInCount` (denormalized + maintained by Cloud Functions, so it updates in real time via the existing event listener — no separate Firestore reads). Renders anonymous dots around a center count, with a brief scale-pulse when the count climbs. |
| <code>LiveOthersInRoomLine</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:1953</code> | — | — | Compact co-presence indicator. Tells the attendee they're not in here alone, with a brief alpha-pulse the moment the count climbs. Used on solo-feeling surfaces (questionnaire, eventually First Hello / wingman). |
| <code>NoCompanionActionsCard</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:2044</code> | — | — | No class documentation or registry summary. |
| <code>PaperBarcode</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:580</code> | — | — | No class documentation or registry summary. |
| <code>PaperCompanionNav</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:185</code> | — | — | No class documentation or registry summary. |
| <code>PaperCompanionTicket</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:279</code> | — | — | No class documentation or registry summary. |
| <code>PaperExpectationCard</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:618</code> | — | — | No class documentation or registry summary. |
| <code>PaperExpectationRow</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:669</code> | — | — | No class documentation or registry summary. |
| <code>PaperPrivacyCard</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:694</code> | — | — | No class documentation or registry summary. |
| <code>PaperProgressRail</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:245</code> | — | — | No class documentation or registry summary. |
| <code>PaperSelfCheckInBar</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:728</code> | — | — | No class documentation or registry summary. |
| <code>PaperTicketDetail</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:485</code> | — | — | No class documentation or registry summary. |
| <code>PaperTicketHeader</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:381</code> | — | — | No class documentation or registry summary. |
| <code>PaperTicketPerforation</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:519</code> | — | — | No class documentation or registry summary. |
| <code>PaperTicketSerial</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:560</code> | — | — | No class documentation or registry summary. |
| <code>StageActionDock</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:1314</code> | — | — | No class documentation or registry summary. |
| <code>StageBouncyChip</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:1706</code> | — | — | Stage-native chip that mirrors `CatchChip.selectable`'s selected/unselected styling while using [StageBouncyPress] instead of Material ink. |
| <code>StageBouncyPress</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:1581</code> | — | — | Gives the wrapped widget a kinetic press response: scale down on tap-down, brief glow flare, then a spring-back to rest. Drop-in replacement for InkWell-style affordances on the stage where Material's ink ripple feels out of place against the gradient + motif backdrop. |
| <code>StageGlyph</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:1111</code> | — | — | Animates a one-shot entry on first build, then breathes the glyph continuously so the hero element never reads as static between moments. |
| <code>StageNav</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:975</code> | — | — | No class documentation or registry summary. |
| <code>StagePanel</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:1261</code> | — | — | Ambient stage card. The border alpha breathes on a 6s sine so the surface never reads as static — even when no content is changing. |
| <code>StagePrivacyLine</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:1193</code> | — | — | No class documentation or registry summary. |
| <code>StageSoftBand</code> | <code>lib/event_success/presentation/companion_parts/event_success_companion_shared.dart:1333</code> | — | — | No class documentation or registry summary. |
...
| <code>EventAssistanceCheckpointReporterSection</code> | <code>lib/event_success/presentation/event_assistance_checkpoint_reporter_section.dart:9</code> | — | — | Revealed inside request management; choices never grant new group access. |
| <code>EventAssistanceCheckpointRequestSection</code> | <code>lib/event_success/presentation/event_assistance_checkpoint_request_section.dart:14</code> | — | — | Closing a request resolves the obligation, without inventing arrival evidence. |
...
| <code>EventAssistanceCheckpointGuestRow</code> | <code>lib/event_success/presentation/event_assistance_checkpoint_roster_section.dart:107</code> | — | — | No class documentation or registry summary. |
...
| <code>EventAssistanceLiveSettingsSection</code> | <code>lib/event_success/presentation/event_assistance_live_settings_section.dart:14</code> | — | — | A compact event default with group overrides disclosed only on request. |
...
| <code>CompanionError</code> | <code>lib/event_success/presentation/event_success_companion_screen.dart:221</code> | — | — | No class documentation or registry summary. |
| <code>CompanionLoading</code> | <code>lib/event_success/presentation/event_success_companion_screen.dart:110</code> | — | — | No class documentation or registry summary. |
| <code>CompanionMessage</code> | <code>lib/event_success/presentation/event_success_companion_screen.dart:251</code> | — | — | No class documentation or registry summary. |
| <code>CompanionPrimaryActionSkeleton</code> | <code>lib/event_success/presentation/event_success_companion_screen.dart:194</code> | — | — | No class documentation or registry summary. |
| <code>CompanionScaffold</code> | <code>lib/event_success/presentation/event_success_companion_screen.dart:82</code> | — | — | No class documentation or registry summary. |
| <code>CompanionStageSkeleton</code> | <code>lib/event_success/presentation/event_success_companion_screen.dart:149</code> | — | — | No class documentation or registry summary. |
| <code>EventSuccessCompanionLoadingBody</code> | <code>lib/event_success/presentation/event_success_companion_screen.dart:119</code> | — | — | No class documentation or registry summary. |
...
| <code>EventSuccessHostPanel</code> | <code>lib/event_success/presentation/event_success_host_screen.dart:1206</code> | — | — | No class documentation or registry summary. |
| <code>EventSuccessHostResourceError</code> | <code>lib/event_success/presentation/event_success_host_screen.dart:959</code> | — | — | No class documentation or registry summary. |
| <code>EventSuccessHostSection</code> | <code>lib/event_success/presentation/event_success_host_screen.dart:105</code> | — | — | No class documentation or registry summary. |
| <code>EventSuccessHostSectionSkeleton</code> | <code>lib/event_success/presentation/event_success_host_screen.dart:1020</code> | — | — | No class documentation or registry summary. |
| <code>EventSuccessLiveTabSkeleton</code> | <code>lib/event_success/presentation/event_success_host_screen.dart:1080</code> | — | — | No class documentation or registry summary. |
| <code>EventSuccessReportMetricsSkeleton</code> | <code>lib/event_success/presentation/event_success_host_screen.dart:1164</code> | — | — | No class documentation or registry summary. |
| <code>EventSuccessReportTabSkeleton</code> | <code>lib/event_success/presentation/event_success_host_screen.dart:1106</code> | — | — | No class documentation or registry summary. |
| <code>EventSuccessSetupControlsSkeleton</code> | <code>lib/event_success/presentation/event_success_host_screen.dart:1132</code> | — | — | No class documentation or registry summary. |
| <code>EventSuccessSetupTabSkeleton</code> | <code>lib/event_success/presentation/event_success_host_screen.dart:1054</code> | — | — | No class documentation or registry summary. |
...
| <code>EventSuccessAccountabilityCard</code> | <code>lib/event_success/presentation/host_parts/event_success_host_live.dart:828</code> | — | — | No class documentation or registry summary. |
| <code>LiveNowConsole</code> | <code>lib/event_success/presentation/host_parts/event_success_host_live.dart:1171</code> | — | — | No class documentation or registry summary. |
| <code>LiveStepNavigation</code> | <code>lib/event_success/presentation/host_parts/event_success_host_live.dart:1744</code> | — | — | No class documentation or registry summary. |
...
| <code>GroupOverrideRoundEditor</code> | <code>lib/event_success/presentation/host_parts/event_success_host_overrides.dart:401</code> | — | — | No class documentation or registry summary. |
| <code>GroupOverrideSheet</code> | <code>lib/event_success/presentation/host_parts/event_success_host_overrides.dart:192</code> | — | — | No class documentation or registry summary. |
| <code>GroupOverrideUnitEditor</code> | <code>lib/event_success/presentation/host_parts/event_success_host_overrides.dart:483</code> | — | — | No class documentation or registry summary. |
| <code>MicroPodsHostCard</code> | <code>lib/event_success/presentation/host_parts/event_success_host_overrides.dart:3</code> | — | — | No class documentation or registry summary. |
| <code>PodGroupSummary</code> | <code>lib/event_success/presentation/host_parts/event_success_host_overrides.dart:1248</code> | — | — | No class documentation or registry summary. |
| <code>RotationOverridePairEditor</code> | <code>lib/event_success/presentation/host_parts/event_success_host_overrides.dart:1164</code> | — | — | No class documentation or registry summary. |
| <code>RotationOverrideRoundEditor</code> | <code>lib/event_success/presentation/host_parts/event_success_host_overrides.dart:1089</code> | — | — | No class documentation or registry summary. |
| <code>RotationOverrideSheet</code> | <code>lib/event_success/presentation/host_parts/event_success_host_overrides.dart:901</code> | — | — | No class documentation or registry summary. |
| <code>RotationsHostCard</code> | <code>lib/event_success/presentation/host_parts/event_success_host_overrides.dart:632</code> | — | — | No class documentation or registry summary. |
| <code>HostFunnelSummary</code> | <code>lib/event_success/presentation/host_parts/event_success_host_report.dart:297</code> | — | — | No class documentation or registry summary. |
| <code>HostReportSignalGrid</code> | <code>lib/event_success/presentation/host_parts/event_success_host_report.dart:189</code> | — | — | No class documentation or registry summary. |
| <code>ReportTab</code> | <code>lib/event_success/presentation/host_parts/event_success_host_report.dart:3</code> | — | — | No class documentation or registry summary. |
| <code>NoticeCard</code> | <code>lib/event_success/presentation/host_parts/event_success_host_setup.dart:396</code> | — | — | No class documentation or registry summary. |
| <code>ReadinessIssues</code> | <code>lib/event_success/presentation/host_parts/event_success_host_setup.dart:366</code> | — | — | No class documentation or registry summary. |
| <code>SetupTab</code> | <code>lib/event_success/presentation/host_parts/event_success_host_setup.dart:3</code> | — | — | No class documentation or registry summary. |
| <code>TargetAttendeeControl</code> | <code>lib/event_success/presentation/host_parts/event_success_host_setup.dart:316</code> | — | — | No class documentation or registry summary. |
| <code>CompatibilitySignalHostCard</code> | <code>lib/event_success/presentation/host_parts/event_success_host_shared.dart:179</code> | — | — | No class documentation or registry summary. |
| <code>EventSuccessHostTabBody</code> | <code>lib/event_success/presentation/host_parts/event_success_host_shared.dart:66</code> | — | — | No class documentation or registry summary. |
| <code>EventSuccessLiveWorkspacePicker</code> | <code>lib/event_success/presentation/host_parts/event_success_host_shared.dart:3</code> | — | — | No class documentation or registry summary. |
| <code>EventSuccessTabPicker</code> | <code>lib/event_success/presentation/host_parts/event_success_host_shared.dart:43</code> | — | — | No class documentation or registry summary. |
| <code>HostActivitySummary</code> | <code>lib/event_success/presentation/host_parts/event_success_host_shared.dart:149</code> | — | — | No class documentation or registry summary. |
| <code>PlanSummary</code> | <code>lib/event_success/presentation/host_parts/event_success_host_shared.dart:113</code> | — | — | No class documentation or registry summary. |
| <code>WingmanRequestHostRow</code> | <code>lib/event_success/presentation/host_parts/event_success_host_shared.dart:268</code> | — | — | No class documentation or registry summary. |
| <code>WingmanRequestsHostCard</code> | <code>lib/event_success/presentation/host_parts/event_success_host_shared.dart:218</code> | — | — | No class documentation or registry summary. |
| <code>HostRevealActions</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_actions.dart:3</code> | — | — | No class documentation or registry summary. |
| <code>EventSuccessLiveRevealAttendeeCard</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_attendee.dart:3</code> | — | — | No class documentation or registry summary. |
| <code>EventSuccessLiveRevealHostCard</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_host.dart:3</code> | — | — | No class documentation or registry summary. |
| <code>AssignmentUnlockedShell</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:1191</code> | — | — | No class documentation or registry summary. |
| <code>AttendeeCountdown</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:117</code> | — | — | No class documentation or registry summary. |
| <code>CountdownBeatRail</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:406</code> | — | — | No class documentation or registry summary. |
| <code>CountdownCuePill</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:537</code> | — | — | No class documentation or registry summary. |
| <code>CountdownCueStack</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:506</code> | — | — | No class documentation or registry summary. |
| <code>CountdownNumber</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:11</code> | — | — | No class documentation or registry summary. |
| <code>CountdownStageDial</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:272</code> | — | — | No class documentation or registry summary. |
| <code>EventSuccessOutcomeRecorder</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:920</code> | — | — | No class documentation or registry summary. |
| <code>RevealGroupSlotRow</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:1227</code> | — | — | No class documentation or registry summary. |
| <code>RevealHostCopy</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:66</code> | — | — | No class documentation or registry summary. |
| <code>RevealHostStatusLayout</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:1583</code> | — | — | No class documentation or registry summary. |
| <code>RevealProgressBar</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:97</code> | — | — | No class documentation or registry summary. |
| <code>RevealRoundList</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:1377</code> | — | — | Design-system `RotationCard` round list, dark-adapted for the reveal stage: a config mono line over one row per round — `R{n}`, the pairings (or "Hidden until reveal" while masked), and a Done / Now / Hidden state badge. Pairings only render for rounds the host has already released. |
| <code>RevealRoundRail</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:1533</code> | — | — | No class documentation or registry summary. |
| <code>RevealRoundRow</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:1428</code> | — | — | No class documentation or registry summary. |
| <code>RevealSlotRow</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:1315</code> | — | — | No class documentation or registry summary. |
| <code>RevealTicker</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:1612</code> | — | — | No class documentation or registry summary. |
| <code>VisibleGroupRotationSlots</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:1155</code> | — | — | No class documentation or registry summary. |
| <code>VisiblePodAssignment</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:816</code> | — | — | No class documentation or registry summary. |
| <code>VisibleRotationSlots</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:1112</code> | — | — | No class documentation or registry summary. |
| <code>VisibleStandings</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:864</code> | — | — | No class documentation or registry summary. |
| <code>WaitingRevealCue</code> | <code>lib/event_success/presentation/live_reveal_parts/event_success_live_reveal_widgets.dart:770</code> | — | — | No class documentation or registry summary. |
| <code>CalendarAgendaSliverSection</code> | <code>lib/events/presentation/calendar/calendar_screen.dart:281</code> | — | — | No class documentation or registry summary. |
| <code>CalendarDateHeader</code> | <code>lib/events/presentation/calendar/calendar_screen.dart:421</code> | — | — | No class documentation or registry summary. |
| <code>CalendarDateHeaderSkeleton</code> | <code>lib/events/presentation/calendar/calendar_screen.dart:476</code> | — | — | No class documentation or registry summary. |
| <code>CalendarMonthGrid</code> | <code>lib/events/presentation/calendar/calendar_screen.dart:709</code> | — | — | No class documentation or registry summary. |
| <code>CalendarStatDivider</code> | <code>lib/events/presentation/calendar/calendar_screen.dart:795</code> | — | — | No class documentation or registry summary. |
| <code>CalendarStatSkeleton</code> | <code>lib/events/presentation/calendar/calendar_screen.dart:649</code> | — | — | No class documentation or registry summary. |
| <code>CalendarStatsHeader</code> | <code>lib/events/presentation/calendar/calendar_screen.dart:549</code> | — | — | No class documentation or registry summary. |
| <code>CalendarStatsHeaderSkeleton</code> | <code>lib/events/presentation/calendar/calendar_screen.dart:612</code> | — | — | No class documentation or registry summary. |
| <code>CalendarWeekStrip</code> | <code>lib/events/presentation/calendar/calendar_screen.dart:665</code> | — | — | No class documentation or registry summary. |
| <code>CalendarWeekStripSkeleton</code> | <code>lib/events/presentation/calendar/calendar_screen.dart:488</code> | — | — | No class documentation or registry summary. |
...
| <code>EventMapLoadingBody</code> | <code>lib/events/presentation/event_map_screen.dart:194</code> | — | — | No class documentation or registry summary. |
| <code>EventMapView</code> | <code>lib/events/presentation/event_map_screen.dart:21</code> | — | — | No class documentation or registry summary. |
...
| <code>SavedEventsAgendaSliver</code> | <code>lib/events/presentation/saved_events_screen.dart:143</code> | — | — | No class documentation or registry summary. |
| <code>SavedEventsClubNamesErrorSliver</code> | <code>lib/events/presentation/saved_events_screen.dart:205</code> | — | — | No class documentation or registry summary. |
| <code>SavedEventsError</code> | <code>lib/events/presentation/saved_events_screen.dart:189</code> | — | — | No class documentation or registry summary. |
| <code>SavedEventsLoading</code> | <code>lib/events/presentation/saved_events_screen.dart:180</code> | — | — | No class documentation or registry summary. |
...
| <code>EventCompanionEntry</code> | <code>lib/events/presentation/widgets/event_detail_body.dart:276</code> | — | — | Provider-free companion prompt adapter for hidden, loading, error, and available Event Success plan states. |
...
| <code>EventDetailCalloutCard</code> | <code>lib/events/presentation/widgets/event_detail_body.dart:204</code> | — | — | No class documentation or registry summary. |
| <code>EventDetailHostsSection</code> | <code>lib/events/presentation/widgets/event_detail_body.dart:337</code> | — | — | Compact host identity, with all affordances derived from available actions. |
| <code>GuestBookCta</code> | <code>lib/events/presentation/widgets/event_detail_body.dart:315</code> | — | — | No class documentation or registry summary. |
...
| <code>EmptyRosterMessage</code> | <code>lib/events/presentation/widgets/who_is_going.dart:184</code> | — | — | No class documentation or registry summary. |
| <code>SwipeWindowBanner</code> | <code>lib/events/presentation/widgets/who_is_going.dart:241</code> | — | — | No class documentation or registry summary. |
| <code>WhoIsGoing</code> | <code>lib/events/presentation/widgets/who_is_going.dart:33</code> | — | — | No class documentation or registry summary. |
| <code>WhoIsGoingContent</code> | <code>lib/events/presentation/widgets/who_is_going.dart:79</code> | — | — | No class documentation or registry summary. |
...
| <code>HostContactMergeCandidateCard</code> | <code>lib/hosts/presentation/customers/host_contact_merge_review.dart:154</code> | — | — | No class documentation or registry summary. |
...
| <code>HostCustomerApplicationSnapshot</code> | <code>lib/hosts/presentation/customers/host_customer_applications_panel.dart:118</code> | — | — | Displays the same grant-filtered answers as the application detail route. These remain a dated submission rather than becoming editable CRM fields. |
...
| <code>HostCustomerAttendanceCard</code> | <code>lib/hosts/presentation/customers/host_customer_detail_cards.dart:392</code> | — | — | No class documentation or registry summary. |
| <code>HostCustomerDetailsSection</code> | <code>lib/hosts/presentation/customers/host_customer_detail_cards.dart:459</code> | — | — | No class documentation or registry summary. |
...
| <code>HostCustomerRevenueBreakdown</code> | <code>lib/hosts/presentation/customers/host_customer_detail_cards.dart:705</code> | — | — | No class documentation or registry summary. |
| <code>HostCustomerRevenueCard</code> | <code>lib/hosts/presentation/customers/host_customer_detail_cards.dart:617</code> | — | — | No class documentation or registry summary. |
| <code>HostCustomerActiveMergesSection</code> | <code>lib/hosts/presentation/customers/host_customer_detail_screen.dart:836</code> | — | — | No class documentation or registry summary. |
...
| <code>HostCustomerMemoryPreview</code> | <code>lib/hosts/presentation/customers/host_customer_memory.dart:16</code> | — | — | No class documentation or registry summary. |
| <code>HostCustomerMemorySection</code> | <code>lib/hosts/presentation/customers/host_customer_memory.dart:45</code> | — | — | No class documentation or registry summary. |
| <code>HostCustomerNoteSheet</code> | <code>lib/hosts/presentation/customers/host_customer_memory.dart:192</code> | — | — | No class documentation or registry summary. |
| <code>HostCustomerTagsSheet</code> | <code>lib/hosts/presentation/customers/host_customer_memory.dart:290</code> | — | — | No class documentation or registry summary. |
| <code>HostCustomerRow</code> | <code>lib/hosts/presentation/customers/host_customer_row.dart:9</code> | — | — | Domain adapter: formats CRM evidence; the person-row primitive owns identity, avatar, hierarchy, adaptive status placement, and interaction geometry. |
| <code>HostCustomerHistoryFilters</code> | <code>lib/hosts/presentation/customers/host_customer_timeline.dart:322</code> | — | — | No class documentation or registry summary. |
| <code>HostCustomerReachSection</code> | <code>lib/hosts/presentation/customers/host_customer_timeline.dart:10</code> | — | — | No class documentation or registry summary. |
| <code>HostCustomerTimelineRecord</code> | <code>lib/hosts/presentation/customers/host_customer_timeline.dart:515</code> | — | — | No class documentation or registry summary. |
| <code>HostCustomerTimelineSection</code> | <code>lib/hosts/presentation/customers/host_customer_timeline.dart:375</code> | — | — | No class documentation or registry summary. |
...
| <code>HostCustomerFilterSheet</code> | <code>lib/hosts/presentation/customers/host_customers_directory.dart:193</code> | — | — | No class documentation or registry summary. |
| <code>HostCustomerFilterSummary</code> | <code>lib/hosts/presentation/customers/host_customers_directory.dart:88</code> | — | — | No class documentation or registry summary. |
| <code>HostCustomersDirectory</code> | <code>lib/hosts/presentation/customers/host_customers_directory.dart:342</code> | — | — | No class documentation or registry summary. |
| <code>HostCustomersNoOrganizer</code> | <code>lib/hosts/presentation/customers/host_customers_directory.dart:56</code> | — | — | No class documentation or registry summary. |
| <code>HostCustomersSummary</code> | <code>lib/hosts/presentation/customers/host_customers_directory.dart:431</code> | — | — | No class documentation or registry summary. |
...
| <code>EditHostedEventScopeNotice</code> | <code>lib/hosts/presentation/edit_hosted_event_screen.dart:1092</code> | — | — | No class documentation or registry summary. |
| <code>EditableHostedEventPolicyCard</code> | <code>lib/hosts/presentation/edit_hosted_event_screen.dart:1166</code> | — | — | No class documentation or registry summary. |
| <code>ReadOnlyHostedEventPolicyCard</code> | <code>lib/hosts/presentation/edit_hosted_event_screen.dart:1461</code> | — | — | No class documentation or registry summary. |
| <code>ReadOnlyHostedEventScheduleCard</code> | <code>lib/hosts/presentation/edit_hosted_event_screen.dart:1526</code> | — | — | No class documentation or registry summary. |
| <code>CreateEventUnsavedChangesDialog</code> | <code>lib/hosts/presentation/event_management/create/create_event_screen.dart:62</code> | — | — | No class documentation or registry summary. |
...
| <code>EventPolicyStep</code> | <code>lib/hosts/presentation/event_management/widgets/event_policy_step.dart:15</code> | — | — | No class documentation or registry summary. |
...
| <code>HostEventActionsSection</code> | <code>lib/hosts/presentation/host_event_manage_screen.dart:1492</code> | — | — | No class documentation or registry summary. |
| <code>HostEventSummaryCard</code> | <code>lib/hosts/presentation/host_event_manage_screen.dart:1718</code> | — | — | No class documentation or registry summary. |
| <code>HostEventSummaryRow</code> | <code>lib/hosts/presentation/host_event_manage_screen.dart:1772</code> | — | — | No class documentation or registry summary. |
| <code>HostFullCapacityApron</code> | <code>lib/hosts/presentation/host_event_manage_screen.dart:1392</code> | — | — | No class documentation or registry summary. |
| <code>HostFullCapacityBanner</code> | <code>lib/hosts/presentation/host_event_manage_screen.dart:1461</code> | — | — | No class documentation or registry summary. |
| <code>HostInviteLinkRow</code> | <code>lib/hosts/presentation/host_event_manage_screen.dart:1194</code> | — | — | No class documentation or registry summary. |
| <code>HostInviteLinksList</code> | <code>lib/hosts/presentation/host_event_manage_screen.dart:1073</code> | — | — | No class documentation or registry summary. |
| <code>HostPrivateAccessBody</code> | <code>lib/hosts/presentation/host_event_manage_screen.dart:959</code> | — | — | No class documentation or registry summary. |
...
| <code>HostCampaignComposer</code> | <code>lib/hosts/presentation/inbox/host_campaign_composer.dart:74</code> | — | — | No class documentation or registry summary. |
| <code>HostCampaignReport</code> | <code>lib/hosts/presentation/inbox/host_campaign_composer.dart:623</code> | — | — | No class documentation or registry summary. |
...
| <code>HostInboxAudienceRail</code> | <code>lib/hosts/presentation/inbox/host_inbox_screen.dart:759</code> | — | — | No class documentation or registry summary. |
| <code>HostInboxEmptyState</code> | <code>lib/hosts/presentation/inbox/host_inbox_screen.dart:902</code> | — | — | No class documentation or registry summary. |
| <code>HostInboxScopeSelector</code> | <code>lib/hosts/presentation/inbox/host_inbox_screen.dart:618</code> | — | — | No class documentation or registry summary. |
| <code>HostInboxWorkspaceSliver</code> | <code>lib/hosts/presentation/inbox/host_inbox_screen.dart:803</code> | — | — | No class documentation or registry summary. |
| <code>HostMessagingWorkspaceRail</code> | <code>lib/hosts/presentation/inbox/host_inbox_screen.dart:582</code> | — | — | No class documentation or registry summary. |
| <code>HostManualSendQueue</code> | <code>lib/hosts/presentation/inbox/host_manual_send_queue.dart:16</code> | — | — | No class documentation or registry summary. |
| <code>HostSendsWorkspaceSliver</code> | <code>lib/hosts/presentation/inbox/host_sends_workspace.dart:31</code> | — | — | No class documentation or registry summary. |
| <code>HostWhatsappThreadRow</code> | <code>lib/hosts/presentation/inbox/host_whatsapp_thread_sheet.dart:16</code> | — | — | No class documentation or registry summary. |
| <code>HostWhatsappThreadSheet</code> | <code>lib/hosts/presentation/inbox/host_whatsapp_thread_sheet.dart:58</code> | — | — | No class documentation or registry summary. |
...
| <code>HostEventAttendancePanel</code> | <code>lib/hosts/presentation/widgets/host_event_attendance_panel.dart:41</code> | — | — | No class documentation or registry summary. |
| <code>HostEventCheckInQrPanel</code> | <code>lib/hosts/presentation/widgets/host_event_attendance_panel.dart:1068</code> | — | — | No class documentation or registry summary. |
| <code>HostEventParticipantsList</code> | <code>lib/hosts/presentation/widgets/host_event_attendance_panel.dart:468</code> | — | — | No class documentation or registry summary. |
| <code>HostEventParticipantsPanel</code> | <code>lib/hosts/presentation/widgets/host_event_attendance_panel.dart:67</code> | — | — | No class documentation or registry summary. |
| <code>HostParticipationLifecycleBoard</code> | <code>lib/hosts/presentation/widgets/host_event_attendance_panel.dart:570</code> | — | — | No class documentation or registry summary. |
| <code>HostRosterFilterHeader</code> | <code>lib/hosts/presentation/widgets/host_event_attendance_panel.dart:1205</code> | — | — | No class documentation or registry summary. |
| <code>HostRosterSearchBar</code> | <code>lib/hosts/presentation/widgets/host_event_attendance_panel.dart:1178</code> | — | — | No class documentation or registry summary. |
| <code>HostWaitlistBulkOfferAction</code> | <code>lib/hosts/presentation/widgets/host_event_attendance_panel.dart:1267</code> | — | — | No class documentation or registry summary. |
...
| <code>HostAnalyticsMetricGridSkeleton</code> | <code>lib/hosts/presentation/widgets/host_loading_skeletons.dart:157</code> | — | — | No class documentation or registry summary. |
| <code>HostAnalyticsReportSkeleton</code> | <code>lib/hosts/presentation/widgets/host_loading_skeletons.dart:100</code> | — | — | No class documentation or registry summary. |
| <code>HostChartSkeleton</code> | <code>lib/hosts/presentation/widgets/host_loading_skeletons.dart:121</code> | — | — | No class documentation or registry summary. |
| <code>HostInlineSkeletonIcon</code> | <code>lib/hosts/presentation/widgets/host_loading_skeletons.dart:146</code> | — | — | No class documentation or registry summary. |
| <code>HostRouteLoadingBody</code> | <code>lib/hosts/presentation/widgets/host_loading_skeletons.dart:5</code> | — | — | No class documentation or registry summary. |
| <code>HostSummarySkeleton</code> | <code>lib/hosts/presentation/widgets/host_loading_skeletons.dart:37</code> | — | — | No class documentation or registry summary. |
| <code>HostTabRailSkeleton</code> | <code>lib/hosts/presentation/widgets/host_loading_skeletons.dart:77</code> | — | — | No class documentation or registry summary. |
| <code>HostGuestIntakeDisclosure</code> | <code>lib/hosts/presentation/widgets/host_operational_roster_panel.dart:60</code> | — | — | No class documentation or registry summary. |
| <code>HostGuestIntakeField</code> | <code>lib/hosts/presentation/widgets/host_operational_roster_panel.dart:34</code> | — | — | No class documentation or registry summary. |
| <code>HostOperationalRosterPanel</code> | <code>lib/hosts/presentation/widgets/host_operational_roster_panel.dart:181</code> | — | — | No class documentation or registry summary. |
| <code>HostRosterImportSheet</code> | <code>lib/hosts/presentation/widgets/host_operational_roster_panel.dart:1804</code> | — | — | No class documentation or registry summary. |
...
| <code>HostTodayEventMetadata</code> | <code>lib/hosts/today/presentation/widgets/host_today_overview.dart:401</code> | — | — | No class documentation or registry summary. |
| <code>HostTodayEventMetric</code> | <code>lib/hosts/today/presentation/widgets/host_today_overview.dart:443</code> | — | — | No class documentation or registry summary. |
| <code>HostTodayEventRow</code> | <code>lib/hosts/today/presentation/widgets/host_today_overview.dart:543</code> | — | — | No class documentation or registry summary. |
| <code>HostTodayEventSpotlight</code> | <code>lib/hosts/today/presentation/widgets/host_today_overview.dart:301</code> | — | — | No class documentation or registry summary. |
| <code>HostTodayOverview</code> | <code>lib/hosts/today/presentation/widgets/host_today_overview.dart:15</code> | — | — | No class documentation or registry summary. |
...
| <code>PaymentCheckoutSheet</code> | <code>lib/payments/presentation/payment_confirmation_screen.dart:245</code> | — | — | No class documentation or registry summary. |
| <code>PaymentConfirmationBody</code> | <code>lib/payments/presentation/payment_confirmation_screen.dart:479</code> | — | — | No class documentation or registry summary. |
| <code>PaymentConfirmationBodyController</code> | <code>lib/payments/presentation/payment_confirmation_screen.dart:430</code> | — | — | No class documentation or registry summary. |
| <code>PaymentConfirmationHeadsUp</code> | <code>lib/payments/presentation/payment_confirmation_screen.dart:609</code> | — | — | No class documentation or registry summary. |
| <code>PaymentPendingCheckoutBody</code> | <code>lib/payments/presentation/payment_confirmation_screen.dart:124</code> | — | — | No class documentation or registry summary. |
| <code>PaymentPendingCheckoutController</code> | <code>lib/payments/presentation/payment_confirmation_screen.dart:70</code> | — | — | No class documentation or registry summary. |
| <code>PaymentReferralBanner</code> | <code>lib/payments/presentation/payment_confirmation_screen.dart:659</code> | — | — | No class documentation or registry summary. |
| <code>PaymentReferralBannerController</code> | <code>lib/payments/presentation/payment_confirmation_screen.dart:638</code> | — | — | No class documentation or registry summary. |
...
| <code>ReviewHistoryItem</code> | <code>lib/reviews/presentation/reviews_history_screen.dart:153</code> | — | — | No class documentation or registry summary. |
| <code>ReviewHistoryItemSkeleton</code> | <code>lib/reviews/presentation/reviews_history_screen.dart:204</code> | — | — | No class documentation or registry summary. |
| <code>ReviewsHistoryBody</code> | <code>lib/reviews/presentation/reviews_history_screen.dart:86</code> | — | — | No class documentation or registry summary. |
| <code>ReviewsHistoryList</code> | <code>lib/reviews/presentation/reviews_history_screen.dart:129</code> | — | — | No class documentation or registry summary. |
| <code>ReviewsHistorySkeleton</code> | <code>lib/reviews/presentation/reviews_history_screen.dart:187</code> | — | — | No class documentation or registry summary. |
...
| <code>RecapHeroSkeleton</code> | <code>lib/swipes/presentation/event_recap_screen.dart:316</code> | — | — | No class documentation or registry summary. |
| <code>RecapProfilePhoto</code> | <code>lib/swipes/presentation/event_recap_screen.dart:601</code> | — | — | No class documentation or registry summary. |
| <code>RecapStat</code> | <code>lib/swipes/presentation/event_recap_screen.dart:473</code> | — | — | No class documentation or registry summary. |
| <code>RecapStatSkeleton</code> | <code>lib/swipes/presentation/event_recap_screen.dart:349</code> | — | — | No class documentation or registry summary. |
| <code>VibeGrid</code> | <code>lib/swipes/presentation/event_recap_screen.dart:213</code> | — | — | No class documentation or registry summary. |
| <code>VibeGridSkeleton</code> | <code>lib/swipes/presentation/event_recap_screen.dart:368</code> | — | — | No class documentation or registry summary. |
| <code>VibeTile</code> | <code>lib/swipes/presentation/event_recap_screen.dart:511</code> | — | — | No class documentation or registry summary. |
| <code>AgeFilterSkeleton</code> | <code>lib/swipes/presentation/filters_screen.dart:387</code> | — | — | No class documentation or registry summary. |
| <code>FiltersContent</code> | <code>lib/swipes/presentation/filters_screen.dart:210</code> | — | — | No class documentation or registry summary. |
| <code>FiltersContentSkeleton</code> | <code>lib/swipes/presentation/filters_screen.dart:338</code> | — | — | No class documentation or registry summary. |
| <code>FiltersSection</code> | <code>lib/swipes/presentation/filters_screen.dart:419</code> | — | — | No class documentation or registry summary. |
| <code>FiltersValue</code> | <code>lib/swipes/presentation/filters_screen.dart:446</code> | — | — | No class documentation or registry summary. |
| <code>CatchesHubContent</code> | <code>lib/swipes/presentation/swipe_hub_screen.dart:111</code> | — | — | No class documentation or registry summary. |
| <code>CatchesHubEmptyState</code> | <code>lib/swipes/presentation/swipe_hub_screen.dart:286</code> | — | — | No class documentation or registry summary. |
| <code>CatchesHubStateView</code> | <code>lib/swipes/presentation/swipe_hub_screen.dart:67</code> | — | — | No class documentation or registry summary. |
| <code>CatchesIntroCard</code> | <code>lib/swipes/presentation/swipe_hub_screen.dart:164</code> | — | — | No class documentation or registry summary. |
| <code>PillStat</code> | <code>lib/swipes/presentation/swipe_hub_screen.dart:248</code> | — | — | No class documentation or registry summary. |
| <code>CatchesBottomScrim</code> | <code>lib/swipes/presentation/swipe_screen.dart:434</code> | — | — | No class documentation or registry summary. |
| <code>CatchesPassButtonSkeleton</code> | <code>lib/swipes/presentation/swipe_screen.dart:347</code> | — | — | No class documentation or registry summary. |
| <code>CatchesProfileReview</code> | <code>lib/swipes/presentation/swipe_screen.dart:218</code> | — | — | No class documentation or registry summary. |
| <code>CatchesProfileReviewSkeleton</code> | <code>lib/swipes/presentation/swipe_screen.dart:172</code> | — | — | No class documentation or registry summary. |
| <code>CatchesTopOverlay</code> | <code>lib/swipes/presentation/swipe_screen.dart:356</code> | — | — | No class documentation or registry summary. |
| <code>CatchesTopOverlaySkeleton</code> | <code>lib/swipes/presentation/swipe_screen.dart:297</code> | — | — | No class documentation or registry summary. |
| <code>OverlayIconSkeleton</code> | <code>lib/swipes/presentation/swipe_screen.dart:338</code> | — | — | No class documentation or registry summary. |
...
| <code>ProfileFieldRow</code> | <code>lib/user_profile/presentation/widgets/profile_tab.dart:301</code> | — | — | No class documentation or registry summary. |
| <code>ProfileMultiEnumEntry</code> | <code>lib/user_profile/presentation/widgets/profile_tab.dart:443</code> | — | — | No class documentation or registry summary. |
| <code>ProfilePhotosSection</code> | <code>lib/user_profile/presentation/widgets/profile_tab.dart:550</code> | — | — | No class documentation or registry summary. |
| <code>ProfilePromptEntry</code> | <code>lib/user_profile/presentation/widgets/profile_tab.dart:510</code> | — | — | No class documentation or registry summary. |
| <code>ProfileSingleEnumEntry</code> | <code>lib/user_profile/presentation/widgets/profile_tab.dart:383</code> | — | — | No class documentation or registry summary. |
| <code>ProfileTab</code> | <code>lib/user_profile/presentation/widgets/profile_tab.dart:27</code> | — | — | No class documentation or registry summary. |
| <code>ProfileTabContent</code> | <code>lib/user_profile/presentation/widgets/profile_tab.dart:102</code> | — | — | No class documentation or registry summary. |
| <code>ProfileTabSliverBody</code> | <code>lib/user_profile/presentation/widgets/profile_tab.dart:71</code> | — | — | No class documentation or registry summary. |
...
| <code>ChatsListScreen</code> | <code>lib/chats/presentation/inbox/chat_inbox_screen.dart:16</code> | — | — | No class documentation or registry summary. |
| <code>ClubDetailScreen</code> | <code>lib/clubs/presentation/detail/club_detail_screen.dart:32</code> | — | — | No class documentation or registry summary. |
...
| <code>DashboardScreen</code> | <code>lib/dashboard/presentation/dashboard_screen.dart:24</code> | — | — | No class documentation or registry summary. |
| <code>HostEventRehearsalScreen</code> | <code>lib/event_rehearsal/presentation/host_event_rehearsal_screen.dart:31</code> | — | — | No class documentation or registry summary. |
...
| <code>EventSuccessCompanionRouteScreen</code> | <code>lib/event_success/presentation/event_success_companion_screen.dart:297</code> | — | — | No class documentation or registry summary. |
...
| <code>CalendarScreen</code> | <code>lib/events/presentation/calendar/calendar_screen.dart:23</code> | — | — | No class documentation or registry summary. |
| <code>EventDetailScreen</code> | <code>lib/events/presentation/event_detail_screen.dart:48</code> | — | — | No class documentation or registry summary. |
...
| <code>HostCustomerDetailScreen</code> | <code>lib/hosts/presentation/customers/host_customer_detail_screen.dart:36</code> | — | — | No class documentation or registry summary. |
...
| <code>HostCustomersScreen</code> | <code>lib/hosts/presentation/customers/host_customers_screen.dart:54</code> | — | — | No class documentation or registry summary. |
...
| <code>EditHostedEventScreen</code> | <code>lib/hosts/presentation/edit_hosted_event_screen.dart:195</code> | — | — | No class documentation or registry summary. |
| <code>CreateEventScreen</code> | <code>lib/hosts/presentation/event_management/create/create_event_screen.dart:75</code> | — | — | No class documentation or registry summary. |
...
| <code>HostFormAutomationsScreen</code> | <code>lib/hosts/presentation/forms/host_form_automations_screen.dart:20</code> | — | — | No class documentation or registry summary. |
...
| <code>HostInboxScreen</code> | <code>lib/hosts/presentation/inbox/host_inbox_screen.dart:37</code> | — | — | No class documentation or registry summary. |
...
| <code>ProfileScreen</code> | <code>lib/user_profile/presentation/profile_screen.dart:23</code> | — | — | No class documentation or registry summary. |
