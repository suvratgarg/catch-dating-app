...
1124 public production Widgets. Source discovery determines membership; the component registry supplies reviewed identity and ladder metadata.

Purpose comes from the first class documentation paragraph, then the registry summary. 819 declarations have neither and remain visible as undocumented. Unreviewed feature Widgets use the existing screen-name boundary for L5/L6; that source classification is not a semantic conformance verdict.
...
| <code>EventAssistanceCheckpointGuestRow</code> | <code>lib/event_success/presentation/event_assistance_checkpoint_roster_section.dart:110</code> | — | — | No class documentation or registry summary. |
...
| <code>EventMessageChannelDisclosure</code> | <code>lib/event_success/presentation/event_message_channel_disclosure.dart:9</code> | — | — | No class documentation or registry summary. |
...
| <code>EventMessagePreferencesEntry</code> | <code>lib/event_success/presentation/event_message_preferences_entry.dart:8</code> | — | — | Consumer event-detail entry. No identity or preference reads until opened. |
