...
1024 public production Widgets. Source discovery determines membership; the component registry supplies reviewed identity and ladder metadata.

Purpose comes from the first class documentation paragraph, then the registry summary. 756 declarations have neither and remain visible as undocumented. Unreviewed feature Widgets use the existing screen-name boundary for L5/L6; that source classification is not a semantic conformance verdict.
