...
| Owner settings | Code cannot confirm them | Owner verifies required checks, environment approvals, secret metadata, token rotation, and whether an organization/merge-queue migration is actually desired |
