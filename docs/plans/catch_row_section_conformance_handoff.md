...
**Implementation authorized on 2026-09-16.** Implement the agreed Events,
Audience, Organizer, Today and person-based Messaging composition, shared
Field/Section boundaries, and executable regression protection. The separate
2026-09-15 dropdown/accordion/autocomplete redesign is deferred; preserve those
controls' existing product behavior while migrating surrounding rows.

The implementation starts at fresh main
